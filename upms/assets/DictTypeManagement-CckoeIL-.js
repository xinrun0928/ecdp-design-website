...
-- ----------------------------
`,xe=`-- Table structure for sys_dict_data
-- ----------------------------
...
-- ----------------------------
`,Ve=["onClick"],Fe=Ne({__name:"DictTypeManagement",setup(p){const c=Ae,O=Ie(),y=Ue.filter(e=>!e.isHidden),g=u(!1),S=u([]),o=u(!1),r=u(!1),T=u(),n=u(99),N=M({dictTypeName:""}),f=b(()=>{const e=y.find(a=>a.subsystemId===n.value);return e?e.subsystemName:""}),A={dictTypeId:0,dictType:"",dictTypeName:"",subsystemId:99,displayOrder:0,remark:"",status:1101},i=M({...A}),k={dictType:[{required:!0,message:"请输入类型编码",trigger:"blur"}],dictTypeName:[{required:!0,message:"请输入类型名称",trigger:"blur"}],subsystemId:[{required:!0,message:"请选择所属子系统",trigger:"change"}]},l=M({pageNum:1,pageSize:20}),D=[{prop:"dictTypeName",label:"类型名称",minWidth:160,slot:"dictTypeName"},{prop:"dictType",label:"类型编码",minWidth:220,cellType:"code"},{prop:"displayOrder",label:"显示排序",width:90},{prop:"status",label:"状态",width:90,cellType:"tag",tagMap:fe,tagLabelMap:Se},{prop:"remark",label:"备注",minWidth:140,cellType:"secondary",showOverflowTooltip:!0},{type:"audit",prop:"creater",label:"创建人"},{type:"audit",prop:"createTime",label:"创建时间"},{type:"audit",prop:"updater",label:"更新人"},{type:"audit",prop:"updateTime",label:"更新时间"},{type:"actions",label:"操作",slot:"actions"}],U=b(()=>{let e=S.value;return e=e.filter(a=>a.subsystemId===n.value),N.dictTypeName&&(e=e.filter(a=>ve(N.dictTypeName,a.dictTypeName))),e}),h=b(()=>U.value.length),R=b(()=>ke(U.value,l.pageNum,l.pageSize)),x=[{label:"编辑",icon:ue,handler:e=>B(e)},{label:"删除",icon:ye,divided:!0,handler:e=>q(e)}];function L(){g.value=!0,setTimeout(()=>{S.value=he(),g.value=!1},300)}function V(e){n.value=e,l.pageNum=1}function F(){l.pageNum=1}function w(e){O.push({path:"/admin/dict/data",query:{dictType:e.dictType,dictTypeName:e.dictTypeName,subsystemName:f.value}})}function W(){r.value=!1,Object.assign(i,A,{subsystemId:n.value}),o.value=!0}function B(e){r.value=!0,Object.assign(i,{dictTypeId:e.dictTypeId,dictType:e.dictType,dictTypeName:e.dictTypeName,subsystemId:n.value,displayOrder:e.displayOrder,remark:e.remark,status:e.status}),o.value=!0}function P(){T.value&&T.value.validate(e=>{e&&(v.success(r.value?"编辑成功":"新增成功"),o.value=!1,L())})}async function q(e){await re(e.dictTypeName)&&(v.success("删除成功"),L())}function X(){var e;(e=T.value)==null||e.resetFields()}return L(),(e,a)=>{const G=I("table-structure-drawer"),H=I("sub-system-panel"),z=ie,$=de,K=se,j=ae,Y=I("split-layout"),E=Te,_=me,Q=ce,J=pe,Z=le,ee=oe,te=ne;return be(),Oe(Me,null,[s(Y,{"aside-title":"子系统列表",title:"字典管理","sub-title":f.value,"expanded-width":"260px","collapsed-width":"72px",collapsed:""},{"title-extra":d(()=>[s(G,{sql:[m(Re),m(xe)]},null,8,["sql"])]),aside:d(({collapsed:t})=>[s(H,{subsystems:m(y),"active-id":n.value,collapsed:t,onSelect:V},null,8,["subsystems","active-id","collapsed"])]),search:d(()=>[s(z,{modelValue:N.dictTypeName,"onUpdate:modelValue":a[0]||(a[0]=t=>N.dictTypeName=t),placeholder:"搜索类型名称",onSearch:F},null,8,["modelValue"])]),actions:d(()=>[s($,{"margin-left":10,onClick:W},{default:d(()=>[...a[10]||(a[10]=[Ee("新增类型",-1)])]),_:1})]),default:d(()=>[s(j,{"page-num":l.pageNum,"onUpdate:pageNum":a[1]||(a[1]=t=>l.pageNum=t),"page-size":l.pageSize,"onUpdate:pageSize":a[2]||(a[2]=t=>l.pageSize=t),data:R.value,columns:D,total:h.value,loading:g.value,"row-key":"dictTypeId","show-tool-bar":!1},{dictTypeName:d(({row:t})=>[ge("span",{class:"cell-link",onClick:we=>w(t)},Le(t.dictTypeName),9,Ve)]),actions:d(({row:t})=>[s(K,{items:x,row:t},null,8,["row"])]),_:1},8,["page-num","page-size","data","total","loading"])]),_:1},8,["sub-title"]),s(te,{modelValue:o.value,"onUpdate:modelValue":a[9]||(a[9]=t=>o.value=t),title:r.value?"编辑字典类型":"新增字典类型",size:"480px",direction:"rtl","destroy-on-close":"","confirm-text":r.value?"保存修改":"确认创建","on-confirm":P,onClosed:X},{default:d(()=>[s(ee,{ref_key:"formRef",ref:T,model:i,rules:k,"label-width":"110px","label-position":"right"},{default:d(()=>[s(_,{label:"类型编码",prop:"dictType"},{default:d(()=>[s(E,{modelValue:i.dictType,"onUpdate:modelValue":a[3]||(a[3]=t=>i.dictType=t),placeholder:"如：sys_normal_disable",maxlength:"100",disabled:r.value},null,8,["modelValue","disabled"])]),_:1}),s(_,{label:"类型名称",prop:"dictTypeName"},{default:d(()=>[s(E,{modelValue:i.dictTypeName,"onUpdate:modelValue":a[4]||(a[4]=t=>i.dictTypeName=t),placeholder:"请输入类型名称",maxlength:"100"},null,8,["modelValue"])]),_:1}),s(_,{label:"所属子系统",prop:"subsystemId"},{default:d(()=>[s(Q,{modelValue:i.subsystemId,"onUpdate:modelValue":a[5]||(a[5]=t=>i.subsystemId=t),options:m(y).map(t=>({label:t.subsystemName,value:t.subsystemId})),disabled:""},null,8,["modelValue","options"])]),_:1}),s(_,{label:"显示排序",prop:"displayOrder"},{default:d(()=>[s(J,{modelValue:i.displayOrder,"onUpdate:modelValue":a[6]||(a[6]=t=>i.displayOrder=t),min:0,max:9999},null,8,["modelValue"])]),_:1}),s(_,{label:"状态",prop:"status"},{default:d(()=>[s(Z,{modelValue:i.status,"onUpdate:modelValue":a[7]||(a[7]=t=>i.status=t),options:m(c)},null,8,["modelValue","options"])]),_:1}),s(_,{label:"备注",prop:"remark"},{default:d(()=>[s(E,{modelValue:i.remark,"onUpdate:modelValue":a[8]||(a[8]=t=>i.remark=t),type:"textarea",rows:3,placeholder:"请输入备注",maxlength:"500","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title","confirm-text"])],64)}}}),Ke=_e(Fe,[["__scopeId","data-v-3da34d57"]]);export{Ke as default};

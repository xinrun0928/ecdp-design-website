...
-- ----------------------------
`,Ze=Ee({__name:"AppPublishLog",setup(Re){function w(t){return[{label:"编辑",icon:Le,handler:()=>R(t)},{label:"发布",icon:he,disabled:t.publishStatus!==d.PENDING,handler:()=>Y(t)},{label:"删除",icon:Ce,divided:!0,handler:()=>Z(t)}]}const U=ye(),F=O(U.query.appName||"App"),P=O(Number(U.query.appId)||0),_=O(""),m=O(""),S={publishId:0,versionCode:"",versionName:"",updateType:C.HOT,wgtVersion:"",downloadUrl:"",releaseNotes:"",isForce:0,fileSize:0,fileMd5:"",publisher:"",publishReason:""},z=[{prop:"versionCode",label:"版本号",width:120,slot:"versionCode"},{prop:"updateType",label:"更新类型",width:100,slot:"updateType"},{prop:"isForce",label:"强制更新",width:90,slot:"isForce"},{prop:"fileSize",label:"包大小",width:100},{prop:"releaseNotes",label:"更新日志",minWidth:200,showOverflowTooltip:!0},{prop:"publishStatus",label:"发布状态",width:100,slot:"publishStatus"},{prop:"publisher",label:"发布人",width:90},{type:"audit",prop:"publishTime",label:"发布时间"},{type:"audit",prop:"createTime",label:"创建时间"},{type:"actions",label:"操作",slot:"actions"}],{drawerVisible:b,isEdit:c,formData:i,openEdit:R,handleSubmit:x,resetForm:k}=Fe({defaultFormData:S,onSubmit:()=>{h.success(c.value?"编辑成功":"新增成功")}}),{allData:B,loading:T,pagination:g,searchKeyword:M,filteredData:$,total:q,handleSearch:L,deleteItem:G}=we({initialData:[],keywordFields:["versionCode"]}),K=Ae(()=>{let t=$.value;return _.value!==""&&(t=t.filter(e=>e.updateType===_.value)),m.value!==""&&(t=t.filter(e=>e.publishStatus===m.value)),t});function W(){x()}function j(){T.value=!0,setTimeout(()=>{B.value=De.filter(t=>t.appId===P.value),T.value=!1},300)}function H(){c.value=!1,Object.assign(i,S),b.value=!0}async function Y(t){await ge(`确定要发布版本 v${t.versionCode} 吗？`)&&(t.publishStatus=d.PUBLISHED,t.publishTime=new Date().toLocaleString(),h.success("发布成功"))}async function Z(t){await Ne(t.versionCode)&&(G(e=>e.publishId!==t.publishId),h.success("删除成功"))}function Q(t){var e;return((e=E.find(s=>s.value===t))==null?void 0:e.label)||"未知"}function X(t){var e;return((e=D.find(s=>s.value===t))==null?void 0:e.label)||"未知"}function J(t){return{[d.PENDING]:"warning",[d.PUBLISHED]:"success",[d.REVOKED]:"info"}[t]||"info"}return Ue(()=>j()),(t,e)=>{const s=A("table-structure-drawer"),ee=_e,v=me,le=de,N=re,ae=se,oe=ue,te=A("panel-layout"),u=Me,n=Te,I=be,pe=ce,ie=fe,ne=Oe;return V(),Se(Ve,null,[o(te,{title:`${F.value} - 发布日志`},{"title-extra":p(()=>[o(s,{sql:a(ze)},null,8,["sql"])]),search:p(()=>[o(ee,{modelValue:a(M),"onUpdate:modelValue":e[0]||(e[0]=l=>y(M)?M.value=l:null),placeholder:"搜索版本号",onSearch:a(L)},null,8,["modelValue","onSearch"]),o(v,{modelValue:_.value,"onUpdate:modelValue":e[1]||(e[1]=l=>_.value=l),placeholder:"选择更新类型",options:a(E),onSearch:a(L)},null,8,["modelValue","options","onSearch"]),o(v,{modelValue:m.value,"onUpdate:modelValue":e[2]||(e[2]=l=>m.value=l),placeholder:"选择发布状态",options:a(D),onSearch:a(L)},null,8,["modelValue","options","onSearch"])]),actions:p(()=>[o(le,{"margin-left":10,onClick:H},{default:p(()=>[...e[16]||(e[16]=[r("新增发布",-1)])]),_:1})]),default:p(()=>[o(oe,{"page-num":a(g).pageNum,"onUpdate:pageNum":e[3]||(e[3]=l=>a(g).pageNum=l),"page-size":a(g).pageSize,"onUpdate:pageSize":e[4]||(e[4]=l=>a(g).pageSize=l),data:K.value,columns:z,total:a(q),loading:a(T),"row-key":"publishId","show-tool-bar":!1,"show-pagination":!1},{versionCode:p(({row:l})=>[o(N,{type:"info",size:"small"},{default:p(()=>[r("v"+f(l.versionCode),1)]),_:2},1024)]),updateType:p(({row:l})=>[o(N,{type:l.updateType===a(C).FULL?"warning":"success",size:"small"},{default:p(()=>[r(f(Q(l.updateType)),1)]),_:2},1032,["type"])]),isForce:p(({row:l})=>[o(N,{type:l.isForce===1?"danger":"info",size:"small"},{default:p(()=>[r(f(l.isForce===1?"是":"否"),1)]),_:2},1032,["type"])]),publishStatus:p(({row:l})=>[o(N,{type:J(l.publishStatus),effect:"light",size:"small",round:""},{default:p(()=>[r(f(X(l.publishStatus)),1)]),_:2},1032,["type"])]),actions:p(({row:l})=>[o(ae,{items:w(l),row:l},null,8,["items","row"])]),_:1},8,["page-num","page-size","data","total","loading"])]),_:1},8,["title"]),o(ne,{modelValue:a(b),"onUpdate:modelValue":e[15]||(e[15]=l=>y(b)?b.value=l:null),title:a(c)?"编辑发布记录":"新增发布记录",size:"480px",direction:"rtl","destroy-on-close":"","confirm-text":a(c)?"保存修改":"确认创建","on-confirm":W,onClosed:a(k)},{default:p(()=>[o(ie,{ref:"formRef",model:a(i),"label-width":"100px","label-position":"right"},{default:p(()=>[o(n,{label:"版本号",prop:"versionCode",rules:[{required:!0,message:"请输入版本号",trigger:"blur"}]},{default:p(()=>[o(u,{modelValue:a(i).versionCode,"onUpdate:modelValue":e[5]||(e[5]=l=>a(i).versionCode=l),placeholder:"如：2.1.0"},null,8,["modelValue"])]),_:1}),o(n,{label:"版本名",prop:"versionName",rules:[{required:!0,message:"请输入版本名",trigger:"blur"}]},{default:p(()=>[o(u,{modelValue:a(i).versionName,"onUpdate:modelValue":e[6]||(e[6]=l=>a(i).versionName=l),placeholder:"如：2.1.0"},null,8,["modelValue"])]),_:1}),o(n,{label:"更新类型",prop:"updateType"},{default:p(()=>[o(I,{modelValue:a(i).updateType,"onUpdate:modelValue":e[7]||(e[7]=l=>a(i).updateType=l),options:a(E)},null,8,["modelValue","options"])]),_:1}),a(i).updateType===a(C).FULL?(V(),ve(n,{key:0,label:"WGT版本",prop:"wgtVersion"},{default:p(()=>[o(u,{modelValue:a(i).wgtVersion,"onUpdate:modelValue":e[8]||(e[8]=l=>a(i).wgtVersion=l),placeholder:"WGT资源版本号"},null,8,["modelValue"])]),_:1})):Ie("",!0),o(n,{label:"下载地址",prop:"downloadUrl"},{default:p(()=>[o(u,{modelValue:a(i).downloadUrl,"onUpdate:modelValue":e[9]||(e[9]=l=>a(i).downloadUrl=l),placeholder:"下载地址"},null,8,["modelValue"])]),_:1}),o(n,{label:"是否强制",prop:"isForce"},{default:p(()=>[o(I,{modelValue:a(i).isForce,"onUpdate:modelValue":e[10]||(e[10]=l=>a(i).isForce=l),options:a(Pe)},null,8,["modelValue","options"])]),_:1}),o(n,{label:"包大小(字节)",prop:"fileSize"},{default:p(()=>[o(pe,{modelValue:a(i).fileSize,"onUpdate:modelValue":e[11]||(e[11]=l=>a(i).fileSize=l),min:0},null,8,["modelValue"])]),_:1}),o(n,{label:"文件MD5",prop:"fileMd5"},{default:p(()=>[o(u,{modelValue:a(i).fileMd5,"onUpdate:modelValue":e[12]||(e[12]=l=>a(i).fileMd5=l),placeholder:"文件MD5校验值"},null,8,["modelValue"])]),_:1}),o(n,{label:"发布人",prop:"publisher"},{default:p(()=>[o(u,{modelValue:a(i).publisher,"onUpdate:modelValue":e[13]||(e[13]=l=>a(i).publisher=l),placeholder:"请输入发布人"},null,8,["modelValue"])]),_:1}),o(n,{label:"更新日志",prop:"releaseNotes"},{default:p(()=>[o(u,{modelValue:a(i).releaseNotes,"onUpdate:modelValue":e[14]||(e[14]=l=>a(i).releaseNotes=l),type:"textarea",rows:4,placeholder:"对外更新日志",maxlength:"500","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title","confirm-text","onClosed"])],64)}}});export{Ze as default};

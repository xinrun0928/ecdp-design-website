import{j as ue,i as se,n as _e,t as me,q as Ne,u as Oe,a as fe,r as Te,m as Ce,f as Le}from"./index-DTgluf9T.js";import{aT as Me,aU as be,aV as Ee,d as Ie,am as he,k as Ue,az as ye,aA as Ae,aR as Se,P as ke,a as x}from"./element-plus-D2VbkOFi.js";/* empty css                     *//* empty css                       */import{o as N}from"./orgTreeData-g3iZN2io.js";import{m as P,a as k}from"./mealData-B-XgC1e1.js";import{G as ve,n as ze,L as M,O as b,W as r,a0 as o,_ as E,$ as I,R as Ve,u as h,P as De,Z as v,r as U,k as F,c as u,aj as z}from"./vue-vendor-CYCT-Zs3.js";import"./randomMock-5mY5cPlO.js";import"./subsystem-BrK1TFZN.js";const we=`-- Table structure for org_organization
-- ----------------------------
...
-- ----------------------------
`,xe={class:"org-name"},Pe=ve({__name:"OrgTreeView",setup(Fe){const y=U(!1),O=U(!1),s=U(!1),f=U(),p=F({name:"",packageType:null,areaName:[]}),e=F({id:0,parentId:0,packageType:null,packageName:"",areaCode:[],name:"",leader:"",contactPhone:"",email:"",description:"",parentCityOrgId:null,parentAffairOrgId:null,parentCompanyOrgId:null}),R=[{prop:"name",label:"组织名称",minWidth:280,align:"left",headerAlign:"left",slot:"name"},{prop:"orgCode",label:"组织编码",width:100,align:"center",showOverflowTooltip:!0},{prop:"packageName",label:"套餐名称",width:140,align:"center",slot:"packageName"},{prop:"packageType",label:"套餐类型",width:110,align:"center",slot:"packageType"},{prop:"areaName",label:"归属地区",width:120,align:"center",showOverflowTooltip:!0,formatter:n=>n.areaName||"-"},{prop:"status",label:"状态",width:90,align:"center",slot:"status"},{prop:"leader",label:"负责人",width:100,align:"center",showOverflowTooltip:!0,formatter:n=>n.leader||"-"},{prop:"contactPhone",label:"联系电话",width:130,align:"center",showOverflowTooltip:!0,formatter:n=>n.contactPhone||"-"},{prop:"email",label:"邮箱",minWidth:150,showOverflowTooltip:!0,formatter:n=>n.email||"-"},{prop:"members",label:"成员数",width:80,align:"center",formatter:n=>{var a;return((a=n.members)==null?void 0:a.length)||0}},{prop:"creater",label:"创建人",width:100,align:"center",formatter:n=>n.creater||"-"},{prop:"createTime",label:"创建时间",width:175,align:"center",formatter:n=>n.createTime||"-"},{prop:"updater",label:"更新人",width:100,align:"center",formatter:n=>n.updater||"-"},{prop:"updateTime",label:"更新时间",width:175,align:"center",formatter:n=>n.updateTime||"-"},{prop:"actions",label:"操作",width:60,align:"center",fixed:"right",slot:"actions"}],B=u(()=>e.packageType?k[e.packageType]||[]:[]),q=u(()=>T(N).filter(a=>a.packageName==="市交通"||a.packageName==="交通")),$=u(()=>T(N).filter(a=>a.packageName==="事务中心"||a.packageName==="省事务中心"||a.packageName==="市事务中心")),G=u(()=>T(N).filter(a=>a.packageName==="公司"||a.packageName==="省交通公司")),X=u(()=>[{id:0,name:"（顶级组织）",children:N}]),W=u(()=>{let n=N;if(p.name||p.packageType!==null||p.areaName.length){const i=T(n).filter(l=>{const c=!p.name||l.name.includes(p.name),g=p.packageType===null||Y(l.packageName)===p.packageType,L=p.areaName[p.areaName.length-1],A=!L||(l.areaName||"").includes(L);return c&&g&&A});n=j(i)}return n});function T(n){const a=[];function i(l){for(const c of l)a.push(c),c.children&&i(c.children)}return i(n),a}function j(n){const a=new Map,i=[];return n.forEach(l=>{a.set(l.id,{...l,children:[]})}),n.forEach(l=>{const c=a.get(l.id),g=K(l,n);g&&a.has(g.id)?a.get(g.id).children.push(c):i.push(c)}),i}function K(n,a){const i=a.findIndex(l=>l.id===n.id);for(let l=i-1;l>=0;l--)if(a[l].id<n.id)return a[l];return null}function Y(n){for(const[a,i]of Object.entries(k))if(i.includes(n))return Number(a);return 0}function V(n){return{省交通本级:"#409EFF",交通:"#67C23A",市交通:"#E6A23C",县交通:"#F56C6C",省事务中心:"#9B59B6",事务中心:"#1ABC9C",市事务中心:"#3498DB",县事务中心:"#2ECC71",省交通公司:"#E74C3C",公司:"#F39C12",监控中心:"#8E44AD",高速公路:"#16A085",普通公路:"#27AE60"}[n]||"#909399"}function H(n){return n&&{1:"顶节点",2:"交通节点",3:"事务中心",4:"公司企业"}[n]||"未知"}function Z(n){return n&&{1:"success",2:"success",3:"warning",4:"danger"}[n]||"info"}const J=[{label:"编辑",icon:Me,handler:n=>Q(n)},{label:"新增子集",icon:be,handler:n=>w(n)},{label:"删除",icon:Ee,divided:!0,handler:n=>ee(n)}];function C(){y.value=!0;try{}finally{y.value=!1}}function D(){C()}function w(n){s.value=!1,e.id=0,e.parentId=(n==null?void 0:n.id)||0,e.packageType=null,e.packageName="",e.areaCode=[],e.name="",e.leader="",e.contactPhone="",e.email="",e.description="",e.parentCityOrgId=null,e.parentAffairOrgId=null,e.parentCompanyOrgId=null,O.value=!0}function Q(n){s.value=!0,e.id=n.id,e.parentId=0;const a=n.packageName;let i=null;for(const[l,c]of Object.entries(k))if(c.includes(a)){i=Number(l);break}e.packageType=i,e.packageName=a,e.areaCode=[],e.name=n.name,e.leader="",e.contactPhone="",e.email="",e.description=n.description,e.parentCityOrgId=null,e.parentAffairOrgId=null,e.parentCompanyOrgId=null,O.value=!0}async function ee(n){await me(n.name)&&(x.success("删除成功"),C())}function ae(){e.packageName="",e.parentCityOrgId=null,e.parentAffairOrgId=null,e.parentCompanyOrgId=null}function ne(n){e.packageName=String(n??""),e.parentCityOrgId=null,e.parentAffairOrgId=null,e.parentCompanyOrgId=null}async function te(){return f.value&&await f.value.validate().catch(()=>!1)?(x.success(s.value?"编辑成功":"新增成功"),C(),!0):!1}function oe(){var n;(n=f.value)==null||n.resetFields()}return ze(()=>{C()}),(n,a)=>{const i=z("table-structure-drawer"),l=Ne,c=Oe,g=fe,L=Ie,A=Ue,S=se,re=ue,le=Te,ie=Se,d=Ae,_=ke,pe=z("area-cascader"),m=_e,ce=ye,de=Ce,ge=z("panel-layout");return M(),b(ge,{title:"组织管理"},{"title-extra":r(()=>[o(i,{sql:h(we)},null,8,["sql"])]),search:r(()=>[o(l,{modelValue:p.name,"onUpdate:modelValue":a[0]||(a[0]=t=>p.name=t),placeholder:"搜索组织名称",onSearch:D},null,8,["modelValue"]),o(c,{modelValue:p.packageType,"onUpdate:modelValue":a[1]||(a[1]=t=>p.packageType=t),placeholder:"套餐类型",options:h(P),"margin-left":10,onSearch:D},null,8,["modelValue","options"])]),actions:r(()=>[o(g,{"margin-left":10,onClick:a[2]||(a[2]=t=>w(null))},{default:r(()=>[...a[16]||(a[16]=[E("新增组织",-1)])]),_:1})]),default:r(()=>[o(le,{data:W.value,columns:R,loading:y.value,"row-key":"id","tree-props":{children:"children",hasChildren:"hasChildren"},"default-expand-all":!0,indent:24,"show-index":!1,"show-pagination":!1,"show-tool-bar":!1},{name:r(({row:t})=>[o(L,{class:"org-icon",style:Ve({color:V(t.packageName)})},{default:r(()=>[o(h(he))]),_:1},8,["style"]),o(A,{content:t.name,placement:"top"},{default:r(()=>[De("span",xe,I(t.name),1)]),_:2},1032,["content"])]),packageName:r(({row:t})=>[o(S,{color:V(t.packageName),effect:"dark",size:"small",round:""},{default:r(()=>[E(I(t.packageName),1)]),_:2},1032,["color"])]),packageType:r(({row:t})=>[o(S,{size:"small",type:Z(t.packageType)},{default:r(()=>[E(I(H(t.packageType)),1)]),_:2},1032,["type"])]),status:r(({row:t})=>[o(S,{size:"small",type:t.status===1101?"success":"info"},{default:r(()=>[E(I(t.status===1101?"正常":"停用"),1)]),_:2},1032,["type"])]),actions:r(({row:t})=>[o(re,{items:J,row:t},null,8,["row"])]),_:1},8,["data","loading"]),o(de,{modelValue:O.value,"onUpdate:modelValue":a[15]||(a[15]=t=>O.value=t),title:s.value?"编辑组织":"新增组织",size:"480px",direction:"rtl","destroy-on-close":"","confirm-text":s.value?"保存修改":"确认创建","on-confirm":te,onClosed:oe},{default:r(()=>[o(ce,{ref_key:"formRef",ref:f,model:e,"label-width":"110px","label-position":"right"},{default:r(()=>[o(d,{label:"上级节点",prop:"parentId"},{default:r(()=>[o(ie,{modelValue:e.parentId,"onUpdate:modelValue":a[3]||(a[3]=t=>e.parentId=t),data:X.value,props:{label:"name",children:"children"},"node-key":"id",placeholder:"请选择上级节点（不选则为顶级）",clearable:"","check-strictly":"",style:{width:"100%"}},null,8,["modelValue","data"])]),_:1}),o(d,{label:"组织名称",prop:"name",rules:[{required:!0,message:"请输入组织名称",trigger:"blur"}]},{default:r(()=>[o(_,{modelValue:e.name,"onUpdate:modelValue":a[4]||(a[4]=t=>e.name=t),placeholder:"请输入组织名称",maxlength:"100","show-word-limit":""},null,8,["modelValue"])]),_:1}),o(d,{label:"归属地区",prop:"areaCode"},{default:r(()=>[o(pe,{modelValue:e.areaCode,"onUpdate:modelValue":a[5]||(a[5]=t=>e.areaCode=t),placeholder:"请选择归属地区",style:{width:"100%"}},null,8,["modelValue"])]),_:1}),o(d,{label:"套餐类型",prop:"packageType",rules:[{required:!0,message:"请选择套餐类型",trigger:"change"}]},{default:r(()=>[o(m,{modelValue:e.packageType,"onUpdate:modelValue":a[6]||(a[6]=t=>e.packageType=t),options:h(P),placeholder:"请选择套餐类型",onChange:ae},null,8,["modelValue","options"])]),_:1}),o(d,{label:"套餐名称",prop:"packageName",rules:[{required:!0,message:"请选择套餐名称",trigger:"change"}]},{default:r(()=>[o(m,{modelValue:e.packageName,"onUpdate:modelValue":a[7]||(a[7]=t=>e.packageName=t),options:B.value.map(t=>({label:t,value:t})),placeholder:"请选择套餐名称",disabled:!e.packageType,onChange:ne},null,8,["modelValue","options","disabled"])]),_:1}),e.packageType===2||e.packageType===3||e.packageType===4?(M(),b(d,{key:0,label:"上级地市交通",prop:"parentCityOrgId"},{default:r(()=>[o(m,{modelValue:e.parentCityOrgId,"onUpdate:modelValue":a[8]||(a[8]=t=>e.parentCityOrgId=t),options:q.value.map(t=>({label:t.name,value:t.id})),placeholder:"请选择上级地市交通组织",clearable:""},null,8,["modelValue","options"])]),_:1})):v("",!0),e.packageType===3||e.packageType===4?(M(),b(d,{key:1,label:"上级事务中心",prop:"parentAffairOrgId"},{default:r(()=>[o(m,{modelValue:e.parentAffairOrgId,"onUpdate:modelValue":a[9]||(a[9]=t=>e.parentAffairOrgId=t),options:$.value.map(t=>({label:t.name,value:t.id})),placeholder:"请选择上级事务中心组织",clearable:""},null,8,["modelValue","options"])]),_:1})):v("",!0),e.packageType===4?(M(),b(d,{key:2,label:"上级公司企业",prop:"parentCompanyOrgId"},{default:r(()=>[o(m,{modelValue:e.parentCompanyOrgId,"onUpdate:modelValue":a[10]||(a[10]=t=>e.parentCompanyOrgId=t),options:G.value.map(t=>({label:t.name,value:t.id})),placeholder:"请选择上级公司企业组织",clearable:""},null,8,["modelValue","options"])]),_:1})):v("",!0),o(d,{label:"负责人",prop:"leader"},{default:r(()=>[o(_,{modelValue:e.leader,"onUpdate:modelValue":a[11]||(a[11]=t=>e.leader=t),placeholder:"请输入负责人"},null,8,["modelValue"])]),_:1}),o(d,{label:"联系电话",prop:"contactPhone"},{default:r(()=>[o(_,{modelValue:e.contactPhone,"onUpdate:modelValue":a[12]||(a[12]=t=>e.contactPhone=t),placeholder:"请输入联系电话"},null,8,["modelValue"])]),_:1}),o(d,{label:"邮箱",prop:"email"},{default:r(()=>[o(_,{modelValue:e.email,"onUpdate:modelValue":a[13]||(a[13]=t=>e.email=t),placeholder:"请输入邮箱"},null,8,["modelValue"])]),_:1}),o(d,{label:"备注",prop:"description"},{default:r(()=>[o(_,{modelValue:e.description,"onUpdate:modelValue":a[14]||(a[14]=t=>e.description=t),type:"textarea",rows:3,placeholder:"请输入备注",maxlength:"200","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title","confirm-text"])]),_:1})}}}),Ye=Le(Pe,[["__scopeId","data-v-d70ce9d2"]]);export{Ye as default};

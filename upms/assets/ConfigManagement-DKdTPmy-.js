...
-- ----------------------------
`,he=de({__name:"ConfigManagement",setup(Le){const{allData:f,loading:d,pagination:g,searchKeyword:y,pagedData:E,total:C,handleSearch:S}=pe({initialData:[...M],keywordFields:["configLabel"]}),I={configId:0,configLabel:"",configKey:"",configValue:"",configType:c.NO,configGroup:re.SYSTEM,displayOrder:0,status:1101,remark:"",createTime:""},{drawerVisible:u,isEdit:m,submitting:b,formRef:U,formData:s,openCreate:V,openEdit:A,handleSubmit:k,resetForm:h}=fe({defaultFormData:I,onSubmit:async(r,o)=>{f.value=[...f.value],L.success(o?"编辑成功":"新增成功"),await new Promise(_=>setTimeout(_,500)),u.value=!1}}),D={configLabel:[{required:!0,message:"请输入参数名称",trigger:"blur"}],configKey:[{required:!0,message:"请输入参数键名",trigger:"blur"}],configValue:[{required:!0,message:"请输入参数键值",trigger:"blur"}]},x=[{prop:"configLabel",label:"参数名称",minWidth:200,showOverflowTooltip:!0},{prop:"configKey",label:"参数键名",minWidth:240,cellType:"code"},{prop:"configValue",label:"参数键值",minWidth:140,cellType:"code",emptyPlaceholder:"-"},{prop:"configType",label:"系统内置",width:100,cellType:"tag",tagMap:{[c.YES]:"success",[c.NO]:"info"},tagLabelMap:{[c.YES]:"是",[c.NO]:"否"}},{prop:"configGroup",label:"配置分组",width:100},{prop:"displayOrder",label:"显示顺序",width:90},{prop:"status",label:"状态",width:80,cellType:"tag",tagMap:ge,tagLabelMap:ce},{type:"audit",prop:"creater",label:"创建者"},{type:"audit",prop:"createTime",label:"创建时间"},{prop:"remark",label:"备注",minWidth:200,cellType:"secondary",showOverflowTooltip:!0},{type:"actions",label:"操作",slot:"actions"}],G=[{label:"编辑",icon:oe,handler:r=>A(r)},{label:"删除",icon:ne,divided:!0,handler:r=>w(r)}];async function w(r){await Q(r.configLabel)&&(L.success("删除成功"),d.value=!0,setTimeout(()=>{f.value=[...M],d.value=!1},500))}return(r,o)=>{const _=N("table-structure-drawer"),v=j,K=X,Y=$,R=q,F=N("panel-layout"),p=se,t=ie,O=H,P=Z,z=J,B=ae,W=ee;return ye(),me(be,null,[a(F,{title:"配置管理"},{"title-extra":l(()=>[a(_,{sql:e(Oe)},null,8,["sql"])]),search:l(()=>[a(v,{modelValue:e(y),"onUpdate:modelValue":o[0]||(o[0]=n=>T(y)?y.value=n:null),placeholder:"搜索参数名称",onSearch:e(S)},null,8,["modelValue","onSearch"])]),actions:l(()=>[a(K,{"margin-left":10,onClick:e(V)},{default:l(()=>[...o[12]||(o[12]=[_e("新增参数",-1)])]),_:1},8,["onClick"])]),default:l(()=>[a(R,{"page-num":e(g).pageNum,"onUpdate:pageNum":o[1]||(o[1]=n=>e(g).pageNum=n),"page-size":e(g).pageSize,"onUpdate:pageSize":o[2]||(o[2]=n=>e(g).pageSize=n),data:e(E),columns:x,total:e(C),loading:e(d)||e(b),"row-key":"configId","show-tool-bar":!1},{actions:l(({row:n})=>[a(Y,{items:G,row:n},null,8,["row"])]),_:1},8,["page-num","page-size","data","total","loading"])]),_:1}),a(W,{modelValue:e(u),"onUpdate:modelValue":o[11]||(o[11]=n=>T(u)?u.value=n:null),title:e(m)?"编辑参数":"新增参数",size:"480px",direction:"rtl","destroy-on-close":"","confirm-text":e(m)?"保存修改":"确认创建",loading:e(b),"on-confirm":e(k),onClosed:e(h)},{default:l(()=>[a(B,{ref_key:"formRef",ref:U,model:e(s),rules:D,"label-width":"100px","label-position":"right"},{default:l(()=>[a(t,{label:"参数名称",prop:"configLabel"},{default:l(()=>[a(p,{modelValue:e(s).configLabel,"onUpdate:modelValue":o[3]||(o[3]=n=>e(s).configLabel=n),placeholder:"请输入参数名称",maxlength:"100"},null,8,["modelValue"])]),_:1}),a(t,{label:"参数键名",prop:"configKey"},{default:l(()=>[a(p,{modelValue:e(s).configKey,"onUpdate:modelValue":o[4]||(o[4]=n=>e(s).configKey=n),placeholder:"如：sys.index.skinName",maxlength:"100",disabled:e(m)},null,8,["modelValue","disabled"])]),_:1}),a(t,{label:"参数键值",prop:"configValue"},{default:l(()=>[a(p,{modelValue:e(s).configValue,"onUpdate:modelValue":o[5]||(o[5]=n=>e(s).configValue=n),placeholder:"请输入参数键值",maxlength:"500"},null,8,["modelValue"])]),_:1}),a(t,{label:"系统内置",prop:"configType"},{default:l(()=>[a(O,{modelValue:e(s).configType,"onUpdate:modelValue":o[6]||(o[6]=n=>e(s).configType=n),options:e(le)},null,8,["modelValue","options"])]),_:1}),a(t,{label:"配置分组",prop:"configGroup"},{default:l(()=>[a(P,{modelValue:e(s).configGroup,"onUpdate:modelValue":o[7]||(o[7]=n=>e(s).configGroup=n),options:e(te),placeholder:"请选择配置分组",clearable:""},null,8,["modelValue","options"])]),_:1}),a(t,{label:"显示顺序",prop:"displayOrder"},{default:l(()=>[a(z,{modelValue:e(s).displayOrder,"onUpdate:modelValue":o[8]||(o[8]=n=>e(s).displayOrder=n),min:0,max:999},null,8,["modelValue"])]),_:1}),a(t,{label:"状态",prop:"status"},{default:l(()=>[a(O,{modelValue:e(s).status,"onUpdate:modelValue":o[9]||(o[9]=n=>e(s).status=n),options:e(ue)},null,8,["modelValue","options"])]),_:1}),a(t,{label:"备注",prop:"remark"},{default:l(()=>[a(p,{modelValue:e(s).remark,"onUpdate:modelValue":o[10]||(o[10]=n=>e(s).remark=n),type:"textarea",rows:3,placeholder:"请输入备注",maxlength:"500","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title","confirm-text","loading","on-confirm","onClosed"])],64)}}});export{he as default};

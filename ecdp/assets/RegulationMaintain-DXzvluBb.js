import{z as ce,A as se,I as _e,bw as xe,e as pe,U as ge,d as Ne,t as we,u as ke,a as Fe,y as Ye,be as Pe,Y as $e}from"./index-wKl0coRl.js";import{b0 as Be,l as Xe,d as me,at as ye,bA as Oe,bb as Le,bc as Te,bx as ze,Q as fe,Y as Je,a as L,b9 as Ge,bz as He,U as Ke,$ as je,a0 as qe,a9 as We,i as Qe}from"./element-plus-6J5z1N_S.js";/* empty css                     */import{r as oe,a as Ze,_ as et,b as ne,R as w,m as tt}from"./RegulationDetailDrawer.vue_vue_type_style_index_0_lang-COjsOhdY.js";import{u as at}from"./useMockTablePage-BJOlYH3T.js";/* empty css                       */import{G as be,L as Q,M as Z,F as Ce,P as m,a0 as e,W as n,$ as Me,ac as re,u as c,r as N,c as ie,k as Ee,_ as ue,j as lt,Z as ot,aj as de}from"./vue-vendor-B_-BtTOt.js";import{b as nt}from"./common-CRcHQUfu.js";import"./markdown-D0O8fouD.js";import"./editor-DMLWmuk0.js";import"./ol-map-Dw1FiBAf.js";const rt={class:"category-tree-panel"},it={class:"tree-wrapper"},ut={class:"tree-node"},dt={class:"tree-node-label"},ct={class:"tree-node-actions"},st=be({__name:"CategoryTreePanel",props:{categories:{}},emits:["node-click"],setup(ee,{expose:S,emit:k}){const F=xe,p=ee,h=k,C=N(""),Y=ie(()=>{if(!C.value)return p.categories;const u=o=>o.reduce((d,_)=>{const y=_.children?u(_.children):[];return(_.categoryName.includes(C.value)||y.length>0)&&d.push({..._,children:y.length>0?y:void 0}),d},[]);return u(p.categories)}),P=ie(()=>[{categoryId:0,categoryName:"（顶级分类）",children:p.categories}]);function D(u){h("node-click",u)}const M=N(!1),T=N("新增分类"),E=N(),r=Ee({categoryId:void 0,categoryName:"",parentId:0,categoryType:0,displayOrder:0,status:1101,remark:""}),v={categoryName:[{required:!0,message:"请输入分类名称",trigger:"blur"}]};function I(u,o){for(const d of u){if(d.categoryId===o)return d;if(d.children){const _=I(d.children,o);if(_)return _}}}function b(u){let o=0;for(const d of u)if(d.categoryId>o&&(o=d.categoryId),d.children){const _=b(d.children);_>o&&(o=_)}return o+1}function g(u,o){for(let d=0;d<u.length;d++){if(u[d].categoryId===o)return u.splice(d,1),!0;if(u[d].children&&g(u[d].children,o))return!0}return!1}function V(){T.value="新增分类",Object.assign(r,{categoryId:void 0,categoryName:"",parentId:0,categoryType:0,displayOrder:0,status:1101,remark:""}),M.value=!0}function t(u){T.value="编辑分类",Object.assign(r,{categoryId:u.categoryId,categoryName:u.categoryName,parentId:u.parentId??0,categoryType:u.categoryType??0,displayOrder:u.displayOrder??0,status:u.status??1101,remark:u.remark??""}),M.value=!0}async function $(u){await ge(u.categoryName)&&(g(p.categories,u.categoryId),L.success("删除成功"))}async function B(){var u;try{await((u=E.value)==null?void 0:u.validate())}catch{return!1}if(r.categoryId){const o=I(p.categories,r.categoryId);o&&(o.categoryName=r.categoryName,o.parentId=r.parentId,o.categoryType=r.categoryType,o.displayOrder=r.displayOrder,o.status=r.status,o.remark=r.remark,L.success("修改成功"))}else{const d={categoryId:b(p.categories),categoryName:r.categoryName,parentId:r.parentId,categoryType:r.categoryType,displayOrder:r.displayOrder,status:r.status,remark:r.remark};if(r.parentId){const _=I(p.categories,r.parentId);_&&(_.children||(_.children=[]),_.children.push(d))}else p.categories.push(d);L.success("新增成功")}return!0}return S({handleAdd:V}),(u,o)=>{const d=ce,_=Xe,y=me,X=Be,z=ze,f=Te,R=fe,J=_e,G=Je,H=pe,K=Le,j=se;return Q(),Z(Ce,null,[m("div",rt,[e(d,{modelValue:C.value,"onUpdate:modelValue":o[0]||(o[0]=s=>C.value=s),placeholder:"请输入",width:"100%","margin-left":0,clearable:"",class:"tree-search"},null,8,["modelValue"]),m("div",it,[e(X,{data:Y.value,props:{children:"children",label:"categoryName"},"node-key":"categoryId","default-expand-all":"","highlight-current":"",onNodeClick:D},{default:n(({node:s,data:l})=>[m("div",ut,[e(_,{content:s.label,placement:"top",disabled:s.label.length<=10},{default:n(()=>[m("span",dt,Me(s.label),1)]),_:2},1032,["content","disabled"]),m("span",ct,[e(y,{class:"tree-action-icon",onClick:re(a=>t(l),["stop"])},{default:n(()=>[e(c(ye))]),_:1},8,["onClick"]),e(y,{class:"tree-action-icon danger",onClick:re(a=>$(l),["stop"])},{default:n(()=>[e(c(Oe))]),_:1},8,["onClick"])])])]),_:1},8,["data"])])]),e(j,{modelValue:M.value,"onUpdate:modelValue":o[7]||(o[7]=s=>M.value=s),title:T.value,size:"480px","destroy-on-close":"","on-confirm":B},{default:n(()=>[e(K,{ref_key:"formRef",ref:E,model:r,rules:v,"label-width":"90px"},{default:n(()=>[e(f,{label:"上级分类",prop:"parentId"},{default:n(()=>[e(z,{modelValue:r.parentId,"onUpdate:modelValue":o[1]||(o[1]=s=>r.parentId=s),data:P.value,props:{label:"name",children:"children"},"check-strictly":"","render-after-expand":!1,placeholder:"请选择上级分类（不选则为顶级）",clearable:"",class:"full-width"},null,8,["modelValue","data"])]),_:1}),e(f,{label:"分类名称",prop:"categoryName"},{default:n(()=>[e(R,{modelValue:r.categoryName,"onUpdate:modelValue":o[2]||(o[2]=s=>r.categoryName=s),placeholder:"请输入分类名称",maxlength:"50"},null,8,["modelValue"])]),_:1}),e(f,{label:"分类类型"},{default:n(()=>[e(J,{modelValue:r.categoryType,"onUpdate:modelValue":o[3]||(o[3]=s=>r.categoryType=s),options:c(F),placeholder:"请选择"},null,8,["modelValue","options"])]),_:1}),e(f,{label:"排序"},{default:n(()=>[e(G,{modelValue:r.displayOrder,"onUpdate:modelValue":o[4]||(o[4]=s=>r.displayOrder=s),min:0,max:9999,"controls-position":"right",class:"full-width"},null,8,["modelValue"])]),_:1}),e(f,{label:"状态"},{default:n(()=>[e(H,{modelValue:r.status,"onUpdate:modelValue":o[5]||(o[5]=s=>r.status=s),options:c(nt)},null,8,["modelValue","options"])]),_:1}),e(f,{label:"备注"},{default:n(()=>[e(R,{modelValue:r.remark,"onUpdate:modelValue":o[6]||(o[6]=s=>r.remark=s),type:"textarea",rows:2,placeholder:"请输入备注",maxlength:"200","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title"])],64)}}}),_t=Ne(st,[["__scopeId","data-v-2b9adce4"]]),pt=`-- Table structure for duty_regulation
-- ----------------------------
...
-- ----------------------------
`,mt={class:"aside-header-extra"},yt={class:"upload-area"},Ot={class:"upload-content"},Lt={key:0,class:"uploaded-file"},Tt={class:"file-name"},ft=be({__name:"RegulationMaintain",setup(ee){const S=N(""),{allData:k,loading:F,pagination:p,searchKeyword:h,pagedData:C,total:Y,deleteItem:P,upsertItem:D}=at({initialData:tt,keywordFields:["docName"],selectFilters:[{key:"status",field:"status",value:S}]}),M=N(null),T=N(!1),E=N(!1),r=N(null),v=N("新增"),I=N(),b=N(),g=N(null),V={regulationId:void 0,docName:"",version:"",regulationTypeCode:"",regulationTypeLabel:"",description:"",status:"实施",effectiveDate:"",abolitionDate:"",publishDept:"",attachmentJson:[]},t=Ee({...V}),$={docName:[{required:!0,message:"请输入文档名称",trigger:"blur"}],regulationTypeCode:[{required:!0,message:"请选择制度类型",trigger:"change"}]},B=[{prop:"docName",label:"文档名称",minWidth:250,showOverflowTooltip:!0},{prop:"version",label:"版本",width:80},{prop:"regulationTypeLabel",label:"制度类型",width:100},{prop:"status",label:"生效状态",width:90,cellType:"tag",tagMap:{[w.ACTIVE]:"success",[w.REVOKED]:"danger"},tagLabelMap:{[w.ACTIVE]:"实施",[w.REVOKED]:"废止"}},{prop:"effectiveDate",label:"生效时间",width:170},{prop:"abolitionDate",label:"废止时间",width:170,formatter:l=>l.abolitionDate||"-"},{prop:"publishDept",label:"发布部门",width:120,showOverflowTooltip:!0},{type:"audit",prop:"createTime",label:"创建时间"},{type:"audit",prop:"updater",label:"更新人"},{type:"audit",prop:"updateTime",label:"更新时间"},{type:"actions",label:"操作",slot:"actions"}],u=N();function o(){var l;(l=u.value)==null||l.handleAdd()}const d=[{label:"修改",icon:ye,handler:l=>f(l)},{label:"查看",icon:Ge,handler:l=>z(l)},{label:"删除",icon:Oe,divided:!0,handler:l=>R(l)}];function _(l){M.value=l.categoryId,y()}function y(){p.pageNum=1}function X(){v.value="新增",G(),T.value=!0}function z(l){r.value=l,E.value=!0}function f(l){v.value="修改",Object.assign(t,{regulationId:l.regulationId,docName:l.docName,version:l.version,regulationTypeCode:l.regulationTypeCode,regulationTypeLabel:l.regulationTypeLabel,description:l.description??"",status:l.status,effectiveDate:l.effectiveDate??"",abolitionDate:l.abolitionDate??"",publishDept:l.publishDept??"",attachmentJson:l.attachmentJson??[]}),T.value=!0}async function R(l){await ge(l.docName)&&(P(a=>a.regulationId===l.regulationId),L.success("删除成功"))}async function J(){var l;try{await((l=I.value)==null?void 0:l.validate())}catch{return!1}if(t.regulationId){const a=k.value.find(U=>U.regulationId===t.regulationId);a&&(D({...a,docName:t.docName,version:t.version,regulationTypeCode:t.regulationTypeCode,regulationTypeLabel:t.regulationTypeLabel,description:t.description,status:t.status,effectiveDate:t.effectiveDate,abolitionDate:t.abolitionDate,publishDept:t.publishDept,attachmentJson:g.value?[{id:String(Date.now()),name:g.value.name,url:`uploads/${g.value.name}`}]:t.attachmentJson},"regulationId"),L.success("修改成功"))}else D({regulationId:Date.now(),docName:t.docName,version:t.version,regulationTypeCode:t.regulationTypeCode,regulationTypeLabel:t.regulationTypeLabel,status:t.status,description:t.description,effectiveDate:t.effectiveDate,abolitionDate:t.abolitionDate,publishDept:t.publishDept,attachmentJson:g.value?[{id:String(Date.now()),name:g.value.name,url:`uploads/${g.value.name}`}]:[],...$e()},"regulationId"),L.success("新增成功");return!0}function G(){var l;Object.assign(t,{...V}),g.value=null,(l=b.value)==null||l.clearFiles()}function H(l){var a,U;if(l.raw){if(!Pe(l.raw.size,10)){L.error("文件大小不能超过10M"),(a=b.value)==null||a.clearFiles();return}const A=[".doc",".docx"],q=l.raw.name.toLowerCase();if(!A.some(W=>q.endsWith(W))){L.error("仅支持 doc、docx 格式文件"),(U=b.value)==null||U.clearFiles();return}g.value=l.raw,t.attachmentJson=[{id:String(Date.now()),name:l.raw.name,url:`uploads/${l.raw.name}`}]}}function K(){L.warning("只能上传一个文件")}function j(){g.value=null,t.attachmentJson=[]}function s(){g.value=null,t.attachmentJson=[]}return(l,a)=>{const U=de("table-structure-drawer"),A=Fe,q=ce,W=Ye,Ie=ke,Ue=we,Se=de("split-layout"),x=fe,O=Te,he=_e,ve=pe,te=Ke,ae=me,Ae=je,De=Le,Ve=se;return Q(),Z(Ce,null,[e(Se,{"aside-title":"分类",title:"制度维护"},{"title-extra":n(()=>[e(U,{sql:[c(pt),c(gt),c(Nt)]},null,8,["sql"])]),aside:n(()=>[e(_t,{ref_key:"categoryTreeRef",ref:u,categories:c(Ze),onNodeClick:_},null,8,["categories"]),m("div",mt,[e(A,{type:"primary",icon:c(He),size:"small",onClick:o},{default:n(()=>[...a[15]||(a[15]=[ue("新增",-1)])]),_:1},8,["icon"])])]),search:n(()=>[e(q,{modelValue:c(h),"onUpdate:modelValue":a[0]||(a[0]=i=>lt(h)?h.value=i:null),placeholder:"请输入文档名称",onSearch:y},null,8,["modelValue"]),e(W,{modelValue:S.value,"onUpdate:modelValue":a[1]||(a[1]=i=>S.value=i),placeholder:"请选择状态",options:c(oe),onChange:y},null,8,["modelValue","options"])]),actions:n(()=>[e(A,{type:"primary","margin-left":10,onClick:X},{default:n(()=>[...a[16]||(a[16]=[ue("新增制度",-1)])]),_:1})]),default:n(()=>[e(Ue,{"page-num":c(p).pageNum,"onUpdate:pageNum":a[2]||(a[2]=i=>c(p).pageNum=i),"page-size":c(p).pageSize,"onUpdate:pageSize":a[3]||(a[3]=i=>c(p).pageSize=i),data:c(C),columns:B,total:c(Y),loading:c(F),"row-key":"regulationId","show-tool-bar":!1},{actions:n(({row:i})=>[e(Ie,{items:d,row:i},null,8,["row"])]),_:1},8,["page-num","page-size","data","total","loading"])]),_:1}),e(et,{modelValue:E.value,"onUpdate:modelValue":a[4]||(a[4]=i=>E.value=i),data:r.value,title:"制度详情"},null,8,["modelValue","data"]),e(Ve,{modelValue:T.value,"onUpdate:modelValue":a[14]||(a[14]=i=>T.value=i),title:v.value,size:"500px","destroy-on-close":"","on-confirm":J},{default:n(()=>[e(De,{ref_key:"formRef",ref:I,model:t,rules:$,"label-width":"90px","label-position":"right"},{default:n(()=>[e(O,{label:"文档名称",prop:"docName"},{default:n(()=>[e(x,{modelValue:t.docName,"onUpdate:modelValue":a[5]||(a[5]=i=>t.docName=i),placeholder:"输入"},null,8,["modelValue"])]),_:1}),e(O,{label:"版本号"},{default:n(()=>[e(x,{modelValue:t.version,"onUpdate:modelValue":a[6]||(a[6]=i=>t.version=i),placeholder:"输入"},null,8,["modelValue"])]),_:1}),e(O,{label:"制度类型",prop:"regulationTypeCode"},{default:n(()=>[e(he,{modelValue:t.regulationTypeCode,"onUpdate:modelValue":a[7]||(a[7]=i=>t.regulationTypeCode=i),options:c(ne),placeholder:"请选择",class:"full-width",onChange:a[8]||(a[8]=i=>{var le;t.regulationTypeLabel=((le=c(ne).find(Re=>Re.value===i))==null?void 0:le.label)??""})},null,8,["modelValue","options"])]),_:1}),e(O,{label:"描述",prop:"description"},{default:n(()=>[e(x,{modelValue:t.description,"onUpdate:modelValue":a[9]||(a[9]=i=>t.description=i),type:"textarea",rows:4,placeholder:"风险说明"},null,8,["modelValue"])]),_:1}),e(O,{label:"生效状态"},{default:n(()=>[e(ve,{modelValue:t.status,"onUpdate:modelValue":a[10]||(a[10]=i=>t.status=i),options:c(oe)},null,8,["modelValue","options"])]),_:1}),e(O,{label:"生效时间"},{default:n(()=>[e(te,{modelValue:t.effectiveDate,"onUpdate:modelValue":a[11]||(a[11]=i=>t.effectiveDate=i),type:"datetime","value-format":"YYYY-MM-DD HH:mm",format:"YYYY-MM-DD HH:mm",placeholder:"请选择生效时间",class:"full-width"},null,8,["modelValue"])]),_:1}),e(O,{label:"废止时间"},{default:n(()=>[e(te,{modelValue:t.abolitionDate,"onUpdate:modelValue":a[12]||(a[12]=i=>t.abolitionDate=i),type:"datetime","value-format":"YYYY-MM-DD HH:mm",format:"YYYY-MM-DD HH:mm",placeholder:"未废止可留空",clearable:"",class:"full-width"},null,8,["modelValue"])]),_:1}),e(O,{label:"发布部门"},{default:n(()=>[e(x,{modelValue:t.publishDept,"onUpdate:modelValue":a[13]||(a[13]=i=>t.publishDept=i),placeholder:"请输入发布部门"},null,8,["modelValue"])]),_:1}),e(O,{label:"上传文件"},{default:n(()=>{var i;return[m("div",yt,[e(Ae,{ref_key:"uploadRef",ref:b,class:"regulation-upload",drag:"",action:"#","auto-upload":!1,limit:1,accept:".doc,.docx","on-change":H,"on-exceed":K,"on-remove":j},{tip:n(()=>[...a[18]||(a[18]=[m("div",{class:"upload-tip"},"最大10M/个 支持扩展名：doc .docx",-1)])]),default:n(()=>[m("div",Ot,[e(ae,{class:"upload-icon"},{default:n(()=>[e(c(qe))]),_:1}),a[17]||(a[17]=m("div",{class:"upload-text"},"点击或将文件拖拽到这里上传",-1))])]),_:1},512),(i=t.attachmentJson)!=null&&i.length&&!g.value?(Q(),Z("div",Lt,[e(ae,null,{default:n(()=>[e(c(We))]),_:1}),m("span",Tt,Me(t.attachmentJson[0].name),1),e(A,{type:"danger",link:"",icon:c(Qe),onClick:s},null,8,["icon"])])):ot("",!0)])]}),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title"])],64)}}}),Vt=Ne(ft,[["__scopeId","data-v-db38b47f"]]);export{Vt as default};

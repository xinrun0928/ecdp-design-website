import{x as K,aZ as Y,a_ as q,a$ as Z,b0 as j,b1 as J,b2 as Q,b3 as D,b4 as ee,y as ae,a as le,B as te,A as ne,b5 as M,b6 as N,aR as oe,aS as se,k as ie,b7 as C,a9 as _e,C as pe,a6 as re,a5 as ue,d as ge}from"./index-DlrKsU8X.js";import{b9 as de,bn as ce,a as h}from"./element-plus-DrBWcvYy.js";import{c as me,d as Ne}from"./logMockApi-Bl5pY1vv.js";import{G as Le,L as R,M as V,a0 as n,W as _,u as i,_ as x,P as r,$ as L,Z as be,F as Te,r as A,c as b,k as w,aj as f}from"./vue-vendor-BFL4yudo.js";import"./markdown-CGqRJECw.js";import"./editor-CDjaDkQU.js";import"./ol-map-BDSc84yL.js";import"./mockCrud-Diyr-LrV.js";const ye=`-- Table structure for sys_login_log
-- ----------------------------
...
-- ----------------------------
`,Oe={key:0,class:"detail-content"},Ie={class:"detail-summary__main"},Ee={class:"detail-summary__name"},Me={class:"detail-summary__url"},ve={class:"detail-summary__meta"},Se={class:"detail-summary__row"},Ce=Le({__name:"SysLoginLog",setup(Ae){const P=A(Ne),v=A(!1),l=A(null),F=b(()=>{var e,a,o,u,p,d,c,y,O,I,E,m;return[{label:"记录ID",value:(e=l.value)==null?void 0:e.logId,type:"code"},{label:"用户姓名",value:(a=l.value)==null?void 0:a.name},{label:"用户名",value:(o=l.value)==null?void 0:o.userName},{label:"父用户ID",value:(u=l.value)==null?void 0:u.puserId,type:"code"},{label:"用户ID",value:(p=l.value)==null?void 0:p.userId,type:"code"},{label:"组织ID",value:(d=l.value)==null?void 0:d.orgId,type:"code"},{label:"组织名称",value:(c=l.value)==null?void 0:c.orgName},{label:"操作类型",value:((y=l.value)==null?void 0:y.operationType)===C.LOGIN?"登录":"登出"},{label:"客户端",value:(O=l.value)==null?void 0:O.clientId},{label:"授权类型",value:(I=l.value)==null?void 0:I.grantType},{label:"子系统ID",value:(E=l.value)==null?void 0:E.subsystemId,type:"code"},{label:"登录时间",value:(m=l.value)==null?void 0:m.createTime}]}),G=b(()=>{var e,a,o,u,p;return[{label:"IP地址",value:(e=l.value)==null?void 0:e.ip,type:"code"},{label:"地理位置",value:(a=l.value)==null?void 0:a.location},{label:"浏览器",value:(o=l.value)==null?void 0:o.browser},{label:"操作系统",value:(u=l.value)==null?void 0:u.os},{label:"终端ID",value:(p=l.value)==null?void 0:p.terminalId}]}),t=w({userName:"",clientId:"",grantType:"",createTime:null}),g=w({pageNum:1,pageSize:20}),T=b(()=>{var a;let e=P.value;if(t.userName&&(e=e.filter(o=>re(t.userName,o.userName))),t.clientId&&(e=e.filter(o=>o.clientId===t.clientId)),t.grantType&&(e=e.filter(o=>o.grantType===t.grantType)),((a=t.createTime)==null?void 0:a.length)===2){const[o,u]=t.createTime;e=e.filter(p=>{var c;const d=((c=p.createTime)==null?void 0:c.split(" ")[0])??"";return d>=o&&d<=u})}return e}),B=b(()=>T.value.length),k=b(()=>ue(T.value,g.pageNum,g.pageSize)),W=[{prop:"logId",label:"日志ID",width:180},{prop:"userName",label:"用户名",minWidth:150,showOverflowTooltip:!0,emptyPlaceholder:"-"},{prop:"name",label:"用户姓名",width:120,emptyPlaceholder:"-"},{prop:"orgName",label:"组织",width:120,emptyPlaceholder:"-"},{prop:"clientId",label:"客户端",width:120,cellType:"tag",tagMap:q,tagLabelMap:Y},{prop:"grantType",label:"授权类型",width:120,cellType:"tag",tagMap:j,tagLabelMap:Z,emptyPlaceholder:"-"},{prop:"operationType",label:"操作类型",width:100,cellType:"tag",tagMap:Q,tagLabelMap:J},{prop:"terminalId",label:"终端",width:80},{prop:"subsystemId",label:"子系统",width:100,cellType:"tag",tagMap:ee,tagLabelMap:D},{prop:"ip",label:"IP地址",width:130},{prop:"browser",label:"浏览器",width:150,showOverflowTooltip:!0},{type:"audit",prop:"createTime",label:"登录时间"},{type:"actions",label:"操作",slot:"actions"}],z=[{label:"详情",icon:de,handler:e=>X(e)}];function S(){g.pageNum=1}function H(){if(!T.value.length){h.warning("暂无数据可导出");return}_e("登录日志",["记录ID","用户姓名","用户名","父用户ID","用户ID","组织ID","组织名称","客户端","授权类型","操作类型","终端","子系统","IP地址","浏览器","操作系统","登录时间"],T.value.map(e=>[e.logId,e.name,e.userName,e.puserId,e.userId,e.orgId,e.orgName,e.clientId,e.grantType,e.operationType===1?"登录":"登出",e.terminalId,e.subsystemId,e.ip,e.browser,e.os,e.createTime]))}async function X(e){const a=await me(e.logId);a?(l.value=a,v.value=!0):h.warning("未找到详情")}return(e,a)=>{const o=f("table-structure-drawer"),u=te,p=ne,d=oe,c=le,y=ae,O=K,I=f("panel-layout"),E=ie,m=se,U=f("detail-list"),$=pe;return R(),V(Te,null,[n(I,{title:"登录日志"},{"title-extra":_(()=>[n(o,{sql:i(ye)},null,8,["sql"])]),search:_(()=>[n(u,{modelValue:t.userName,"onUpdate:modelValue":a[0]||(a[0]=s=>t.userName=s),placeholder:"搜索用户名",onSearch:S},null,8,["modelValue"]),n(p,{modelValue:t.clientId,"onUpdate:modelValue":a[1]||(a[1]=s=>t.clientId=s),placeholder:"客户端",options:[{label:i(M).SUB_SYSTEM,value:i(M).SUB_SYSTEM},{label:i(M).FLOOD,value:i(M).FLOOD}],onSearch:S},null,8,["modelValue","options"]),n(p,{modelValue:t.grantType,"onUpdate:modelValue":a[2]||(a[2]=s=>t.grantType=s),placeholder:"授权类型",options:[{label:i(N).PASSWORD,value:i(N).PASSWORD},{label:i(N).REFRESH_TOKEN,value:i(N).REFRESH_TOKEN},{label:i(N).MOBILE,value:i(N).MOBILE}],onSearch:S},null,8,["modelValue","options"]),n(d,{modelValue:t.createTime,"onUpdate:modelValue":a[3]||(a[3]=s=>t.createTime=s),"start-placeholder":"开始日期","end-placeholder":"结束日期"},null,8,["modelValue"])]),actions:_(()=>[n(c,{type:"success",icon:i(ce),"margin-left":10,onClick:H},{default:_(()=>[...a[7]||(a[7]=[x("导出",-1)])]),_:1},8,["icon"])]),default:_(()=>[n(O,{"page-num":g.pageNum,"onUpdate:pageNum":a[4]||(a[4]=s=>g.pageNum=s),"page-size":g.pageSize,"onUpdate:pageSize":a[5]||(a[5]=s=>g.pageSize=s),data:k.value,columns:W,total:B.value,"row-key":"logId","show-tool-bar":!1},{actions:_(({row:s})=>[n(y,{items:z,row:s},null,8,["row"])]),_:1},8,["page-num","page-size","data","total"])]),_:1}),n($,{modelValue:v.value,"onUpdate:modelValue":a[6]||(a[6]=s=>v.value=s),title:"登录详情",direction:"rtl",size:"580px","destroy-on-close":"","hide-footer":!0},{default:_(()=>[l.value?(R(),V("div",Oe,[n(m,{class:"detail-summary"},{default:_(()=>[r("div",Ie,[r("span",Ee,L(l.value.userName||"-"),1),r("span",Me,L(l.value.name||"-"),1)]),r("div",ve,[n(E,{type:l.value.operationType===i(C).LOGIN?"success":"info",effect:"dark",round:""},{default:_(()=>[x(L(l.value.operationType===i(C).LOGIN?"登录":"登出"),1)]),_:1},8,["type"]),r("span",null,L(l.value.clientId),1)]),r("div",Se,[r("span",null,L(l.value.grantType),1),r("span",null,L(l.value.subsystemId?i(D)[l.value.subsystemId]||l.value.subsystemId:"-"),1)])]),_:1}),n(m,{class:"detail-section"},{header:_(()=>[...a[8]||(a[8]=[r("span",{class:"detail-section__title"},"基础信息",-1)])]),default:_(()=>[n(U,{items:F.value},null,8,["items"])]),_:1}),n(m,{class:"detail-section"},{header:_(()=>[...a[9]||(a[9]=[r("span",{class:"detail-section__title"},"终端信息",-1)])]),default:_(()=>[n(U,{items:G.value},null,8,["items"])]),_:1})])):be("",!0)]),_:1},8,["modelValue"])],64)}}}),Pe=ge(Ce,[["__scopeId","data-v-ceaaa55c"]]);export{Pe as default};

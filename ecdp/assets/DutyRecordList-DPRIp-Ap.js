import{T as V,be as G,a as k,bj as Y,C as q,d as K,x as W,y as j,a1 as H,a9 as $,aw as J,ax as Q,bf as Z}from"./index-DlrKsU8X.js";import{bb as tt,bc as et,R as at,a0 as rt,d as nt,$ as lt,a as m,au as ot,bz as dt}from"./element-plus-DrBWcvYy.js";/* empty css                     */import{G as B,d as _t,L as P,O as it,W as n,a0 as a,P as N,u as _,_ as C,r as x,c as ut,k as ct,M as Nt,j as pt,F as Ot,aj as F}from"./vue-vendor-BFL4yudo.js";import{m as st}from"./dutyRecordData-Dm0EEYP1.js";import{u as Lt}from"./useMockTablePage-CVH8pgnI.js";import{u as gt}from"./useCrudDrawer-DZTGmGMZ.js";import"./markdown-CGqRJECw.js";import"./editor-CDjaDkQU.js";import"./ol-map-BDSc84yL.js";const Tt={class:"form-field-group"},Mt={class:"form-field-group"},mt={class:"form-field-group"},Ct={class:"form-field-group"},Et={class:"upload-area"},yt={class:"drawer-footer"},bt=B({__name:"DutyRecordFormDrawer",props:{visible:{type:Boolean},editData:{default:void 0}},emits:["update:visible","confirm","cancel"],setup(A,{emit:E}){const u=A,g=E,p=x(),f=x(),T=x(!1),I=ut(()=>{var o;return!!((o=u.editData)!=null&&o.id)}),y=G,e=ct({workSummary:"",importantMatters:"",eventType:"",other:"",files:[]}),s={workSummary:[{required:!0,message:"请输入工作总结",trigger:"blur"}],importantMatters:[{required:!0,message:"请输入重要事项",trigger:"blur"}],eventType:[{required:!0,message:"请选择事件类型",trigger:"change"}]};_t(()=>u.visible,o=>{o&&(u.editData?(e.workSummary=u.editData.workSummary||"",e.importantMatters=u.editData.importantMatters||"",e.eventType=u.editData.eventType||"",e.other=u.editData.other||"",e.files=u.editData.files?[...u.editData.files]:[]):b())});function b(){var o;(o=p.value)==null||o.resetFields(),e.workSummary="",e.importantMatters="",e.eventType="",e.other="",e.files=[]}function S(o,t){if(o.size&&!Y(o.size,50)){m.error("文件大小不能超过 50MB"),t.pop();return}e.files=t.map(d=>{var i;return{id:d.uid,name:d.name||"",url:d.url||"",size:d.size,type:(i=d.raw)==null?void 0:i.type}})}function h(o,t){e.files=t.map(d=>{var i;return{id:d.uid,name:d.name||"",url:d.url||"",size:d.size,type:(i=d.raw)==null?void 0:i.type}})}function v(){m.warning("最多只能上传 5 个文件")}function M(){g("update:visible",!1),g("cancel")}async function D(){var o;if(p.value)try{await p.value.validate(),T.value=!0;const t={id:(o=u.editData)==null?void 0:o.id,workSummary:e.workSummary,importantMatters:e.importantMatters,eventType:e.eventType,other:e.other,files:e.files};g("confirm",t)}catch{}finally{T.value=!1}}return(o,t)=>{const d=at,i=et,R=V,w=nt,l=k,r=rt,c=tt,U=q;return P(),it(U,{"model-value":A.visible,title:I.value?"编辑值班记录":"新增值班记录",direction:"rtl",size:"800px","before-close":M,class:"duty-record-form-drawer","destroy-on-close":""},{footer:n(()=>[N("div",yt,[a(l,{onClick:M},{default:n(()=>[...t[10]||(t[10]=[C("取消",-1)])]),_:1}),a(l,{type:"primary",loading:T.value,onClick:D},{default:n(()=>[...t[11]||(t[11]=[C("确定",-1)])]),_:1},8,["loading"])])]),default:n(()=>[a(c,{ref_key:"formRef",ref:p,model:e,rules:s,"label-width":"100px","label-position":"top"},{default:n(()=>[N("div",Tt,[t[4]||(t[4]=N("div",{class:"field-number"},"1",-1)),a(i,{label:"工作总结",prop:"workSummary"},{default:n(()=>[a(d,{modelValue:e.workSummary,"onUpdate:modelValue":t[0]||(t[0]=O=>e.workSummary=O),type:"textarea",placeholder:"请输入",rows:4,maxlength:"500","show-word-limit":""},null,8,["modelValue"])]),_:1})]),N("div",Mt,[t[5]||(t[5]=N("div",{class:"field-number"},"2",-1)),a(i,{label:"重要事项",prop:"importantMatters"},{default:n(()=>[a(d,{modelValue:e.importantMatters,"onUpdate:modelValue":t[1]||(t[1]=O=>e.importantMatters=O),type:"textarea",placeholder:"请输入",rows:4,maxlength:"500","show-word-limit":""},null,8,["modelValue"])]),_:1})]),N("div",mt,[t[6]||(t[6]=N("div",{class:"field-number"},"3",-1)),a(i,{label:"事件类型",prop:"eventType"},{default:n(()=>[a(R,{modelValue:e.eventType,"onUpdate:modelValue":t[2]||(t[2]=O=>e.eventType=O),placeholder:"下拉选择",options:_(y)},null,8,["modelValue","options"])]),_:1})]),N("div",Ct,[t[7]||(t[7]=N("div",{class:"field-number"},"4",-1)),a(i,{label:"其他",prop:"other"},{default:n(()=>[a(d,{modelValue:e.other,"onUpdate:modelValue":t[3]||(t[3]=O=>e.other=O),type:"textarea",placeholder:"请输入",rows:4,maxlength:"500","show-word-limit":""},null,8,["modelValue"])]),_:1})]),a(i,{label:"上传文件"},{default:n(()=>[N("div",Et,[a(r,{ref_key:"uploadRef",ref:f,"auto-upload":!1,limit:5,"on-change":S,"on-exceed":v,"on-remove":h,"file-list":e.files,accept:".rar,.zip,.doc,.docx,.pdf,.jpg,.jpeg,.png"},{default:n(()=>[a(l,{type:"primary",plain:""},{default:n(()=>[a(w,null,{default:n(()=>[a(_(lt))]),_:1}),t[8]||(t[8]=C(" 上传文件 ",-1))]),_:1})]),_:1},8,["file-list"]),t[9]||(t[9]=N("div",{class:"format-hint"},"支持格式：.rar .zip .doc .docx .pdf .jpg",-1))])]),_:1})]),_:1},8,["model"])]),_:1},8,["model-value","title"])}}}),St=K(bt,[["__scopeId","data-v-8b87cfe0"]]),Ut=`-- Table structure for duty_record
-- ----------------------------
...
-- ----------------------------
`,Xt=B({__name:"DutyRecordList",setup(A){const{allData:E,filteredData:u,loading:g,pagination:p,pagedData:f,total:T,deleteItem:I,upsertItem:y}=Lt({initialData:st}),e={id:0,workSummary:"",importantMatters:"",eventType:"",other:""},{drawerVisible:s,isEdit:b,formData:S,openCreate:h,openEdit:v}=gt({defaultFormData:e}),M=[{prop:"date",label:"值班日期",width:140},{prop:"rule",label:"排班规则",minWidth:180,showOverflowTooltip:!0},{prop:"person",label:"值班人员",width:140},{prop:"fillTime",label:"填报时间",width:180},{type:"actions",label:"操作",slot:"actions"}],D=[{label:"编辑",icon:ot,handler:l=>t(l)},{label:"删除",icon:dt,divided:!0,handler:l=>d(l)}];function o(){h()}function t(l){v(l)}async function d(l){await H(l.date)&&(I(r=>r.id===l.id),m.success("删除成功"))}function i(){const l=M.filter(c=>c.label!=="操作").map(c=>c.label),r=u.value.map(c=>[c.date,c.rule,c.person,c.fillTime]);$("值班记录",l,r)}function R(l){b.value?(y({...E.value.find(r=>r.id===S.id),...l},"id"),m.success("编辑成功")):(y({id:Math.max(...E.value.map(r=>r.id),0)+1,date:Z("YYYY-MM-DD"),rule:"视频会议保障人员",person:Q(),fillTime:J(),...l},"id"),m.success("新增成功")),s.value=!1,p.pageNum=1}function w(){s.value=!1}return(l,r)=>{const c=F("table-structure-drawer"),U=k,O=j,z=W,X=F("panel-layout");return P(),Nt(Ot,null,[a(X,{title:"值班记录"},{"title-extra":n(()=>[a(c,{sql:[_(Ut),_(At),_(ft),_(It),_(ht)]},null,8,["sql"])]),actions:n(()=>[a(U,{"margin-left":10,onClick:o},{default:n(()=>[...r[3]||(r[3]=[C("新增",-1)])]),_:1}),a(U,{type:"info","margin-left":10,onClick:i},{default:n(()=>[...r[4]||(r[4]=[C("导出",-1)])]),_:1})]),default:n(()=>[a(z,{"page-num":_(p).pageNum,"onUpdate:pageNum":r[0]||(r[0]=L=>_(p).pageNum=L),"page-size":_(p).pageSize,"onUpdate:pageSize":r[1]||(r[1]=L=>_(p).pageSize=L),data:_(f),columns:M,total:_(T),loading:_(g),"row-key":"id","show-tool-bar":!1},{actions:n(({row:L})=>[a(O,{items:D,row:L},null,8,["row"])]),_:1},8,["page-num","page-size","data","total","loading"])]),_:1}),a(St,{visible:_(s),"onUpdate:visible":r[2]||(r[2]=L=>pt(s)?s.value=L:null),"edit-data":_(b)?_(S):void 0,onConfirm:R,onCancel:w},null,8,["visible","edit-data"])],64)}}});export{Xt as default};

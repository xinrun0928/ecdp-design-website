import{x as j,aU as K,aV as Y,y as J,a as Z,B as H,aR as Q,aS as ee,k as ae,aW as se,a9 as le,F as te,C as oe,a6 as f,a5 as ne,d as ce}from"./index-DlrKsU8X.js";import{b9 as _e,bn as re,a_ as U,a as A}from"./element-plus-DrBWcvYy.js";import{g as ie,m as pe}from"./logMockApi-Bl5pY1vv.js";import{f as v}from"./json-C7YhXd02.js";import{G as ue,L as m,M as I,a0 as n,W as o,u as i,_ as N,P as l,$ as p,O as D,Z as C,F as ge,r as y,k as h,c as O,aj as M}from"./vue-vendor-BFL4yudo.js";import"./markdown-CGqRJECw.js";import"./editor-CDjaDkQU.js";import"./ol-map-BDSc84yL.js";import"./mockCrud-Diyr-LrV.js";const de=`-- Table structure for sys_access_log
-- ----------------------------
...
-- ----------------------------
`,me={key:0,class:"detail-content"},Ne={class:"detail-summary__main"},Oe={class:"detail-summary__name"},Le={class:"detail-summary__url"},Te={class:"detail-summary__meta"},Ee={class:"payload-section"},Ce={class:"label-row"},ye={class:"json-block"},Me={class:"payload-section"},be={class:"label-row"},Se={class:"json-block"},fe=ue({__name:"SysAccessLog",setup(Ue){const x=y(pe),L=y(!1),s=y(null),c=h({name:"",reqUrl:"",createTime:null}),_=h({pageNum:1,pageSize:20}),g=O(()=>{var e;let a=x.value;if(c.name&&(a=a.filter(r=>f(c.name,r.name))),c.reqUrl&&(a=a.filter(r=>f(c.reqUrl,r.reqUrl))),((e=c.createTime)==null?void 0:e.length)===2){const[r,d]=c.createTime;a=a.filter(T=>{const u=T.createTime.split(" ")[0];return u>=r&&u<=d})}return a}),k=O(()=>g.value.length),q=O(()=>ne(g.value,_.pageNum,_.pageSize)),w=O(()=>s.value?[{label:"日志 ID",value:s.value.id,type:"code"},{label:"访问时间",value:s.value.createTime},{label:"IP 地址",value:s.value.ip,type:"code"},{label:"客户端",value:`${s.value.browser} / ${s.value.os}`}]:[]),R=[{prop:"name",label:"日志名称",minWidth:140},{prop:"reqUrl",label:"请求地址",minWidth:240,align:"left",showOverflowTooltip:!0},{prop:"opMethod",label:"方法",width:80,cellType:"tag",tagMap:{GET:"success",POST:"",PUT:"warning",DELETE:"danger"},tagLabelMap:{GET:"GET",POST:"POST",PUT:"PUT",DELETE:"DELETE"}},{prop:"result",label:"结果",width:100,cellType:"tag",tagMap:Y,tagLabelMap:K},{prop:"repTime",label:"耗时(ms)",width:90},{prop:"ip",label:"IP地址",width:130},{prop:"browser",label:"浏览器",width:100},{prop:"os",label:"操作系统",width:100},{type:"audit",prop:"createTime",label:"访问时间"},{type:"actions",label:"操作",slot:"actions"}],V=[{label:"详情",icon:_e,handler:a=>F(a)}];function b(){_.pageNum=1}function P(){if(!g.value.length){A.warning("暂无数据可导出");return}le("访问日志",["日志ID","日志名称","请求地址","方法","结果","耗时(ms)","IP地址","浏览器","操作系统","访问时间"],g.value.map(a=>[a.id,a.name,a.reqUrl,a.opMethod,a.result,a.repTime,a.ip,a.browser,a.os,a.createTime]))}async function S(a){te(a)}async function F(a){const e=await ie(a.id);e?(s.value=e,L.value=!0):A.warning("未找到详情")}return(a,e)=>{const r=M("table-structure-drawer"),d=H,T=Q,u=Z,G=J,B=j,$=M("panel-layout"),z=ae,E=ee,X=M("detail-list"),W=oe;return m(),I(ge,null,[n($,{title:"访问日志"},{"title-extra":o(()=>[n(r,{sql:i(de)},null,8,["sql"])]),search:o(()=>[n(d,{modelValue:c.name,"onUpdate:modelValue":e[0]||(e[0]=t=>c.name=t),placeholder:"搜索日志名称",onSearch:b},null,8,["modelValue"]),n(d,{modelValue:c.reqUrl,"onUpdate:modelValue":e[1]||(e[1]=t=>c.reqUrl=t),placeholder:"搜索请求地址",onSearch:b},null,8,["modelValue"]),n(T,{modelValue:c.createTime,"onUpdate:modelValue":e[2]||(e[2]=t=>c.createTime=t),"start-placeholder":"开始日期","end-placeholder":"结束日期"},null,8,["modelValue"])]),actions:o(()=>[n(u,{type:"success",icon:i(re),"margin-left":10,onClick:P},{default:o(()=>[...e[8]||(e[8]=[N("导出",-1)])]),_:1},8,["icon"])]),default:o(()=>[n(B,{"page-num":_.pageNum,"onUpdate:pageNum":e[3]||(e[3]=t=>_.pageNum=t),"page-size":_.pageSize,"onUpdate:pageSize":e[4]||(e[4]=t=>_.pageSize=t),data:q.value,columns:R,total:k.value,"row-key":"id","show-tool-bar":!1},{actions:o(({row:t})=>[n(G,{items:V,row:t},null,8,["row"])]),_:1},8,["page-num","page-size","data","total"])]),_:1}),n(W,{modelValue:L.value,"onUpdate:modelValue":e[7]||(e[7]=t=>L.value=t),title:"访问日志详情",direction:"rtl",size:"580px","destroy-on-close":"","hide-footer":!0},{default:o(()=>[s.value?(m(),I("div",me,[n(E,{class:"detail-summary"},{default:o(()=>[l("div",Ne,[l("span",Oe,p(s.value.name),1),l("span",Le,p(s.value.reqUrl),1)]),l("div",Te,[n(z,{type:s.value.result===i(se).SUCCESS?"success":"danger",effect:"dark",round:""},{default:o(()=>[N(p(s.value.result),1)]),_:1},8,["type"]),l("span",null,p(s.value.opMethod),1),l("span",null,p(s.value.repTime)+" ms",1)])]),_:1}),n(E,{class:"detail-section"},{header:o(()=>[...e[9]||(e[9]=[l("span",{class:"detail-section__title"},"基础信息",-1)])]),default:o(()=>[n(X,{items:w.value},null,8,["items"])]),_:1}),n(E,{class:"detail-section"},{header:o(()=>[...e[10]||(e[10]=[l("span",{class:"detail-section__title"},"报文信息",-1)])]),default:o(()=>[l("section",Ee,[l("header",Ce,[e[12]||(e[12]=l("span",{class:"detail-label"},"请求参数",-1)),s.value.reqParams?(m(),D(u,{key:0,link:"",type:"primary",icon:i(U),onClick:e[5]||(e[5]=t=>S(s.value.reqParams))},{default:o(()=>[...e[11]||(e[11]=[N("复制",-1)])]),_:1},8,["icon"])):C("",!0)]),l("pre",ye,p(i(v)(s.value.reqParams||"-")),1)]),l("section",Me,[l("header",be,[e[14]||(e[14]=l("span",{class:"detail-label"},"响应数据",-1)),s.value.repData?(m(),D(u,{key:0,link:"",type:"primary",icon:i(U),onClick:e[6]||(e[6]=t=>S(s.value.repData))},{default:o(()=>[...e[13]||(e[13]=[N("复制",-1)])]),_:1},8,["icon"])):C("",!0)]),l("pre",Se,p(i(v)(s.value.repData||"-")),1)])]),_:1})])):C("",!0)]),_:1},8,["modelValue"])],64)}}}),Re=ce(fe,[["__scopeId","data-v-f0eadf29"]]);export{Re as default};

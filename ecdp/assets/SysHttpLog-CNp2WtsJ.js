import{x as $,aX as z,aY as X,y as J,a as j,A as K,B as Y,aR as Z,a9 as Q,F as ee,C as te,a6 as ae,a5 as le,d as oe}from"./index-DlrKsU8X.js";import{b9 as se,bn as ne,bI as re,bJ as pe,a_ as b,a as ie}from"./element-plus-DrBWcvYy.js";/* empty css                         */import{a as _e,b as de}from"./logMockApi-Bl5pY1vv.js";import{h as ce}from"./common-CRcHQUfu.js";import{f as h}from"./json-C7YhXd02.js";import{G as ue,L as v,M as U,a0 as l,W as s,u as i,_ as m,P as n,$ as M,Z as ge,F as me,r as N,c as T,k as A,aj as C}from"./vue-vendor-BFL4yudo.js";import"./markdown-CGqRJECw.js";import"./editor-CDjaDkQU.js";import"./ol-map-BDSc84yL.js";import"./mockCrud-Diyr-LrV.js";const Ne=`-- Table structure for sys_http_log
-- ----------------------------
...
-- ----------------------------
`,Te={key:0,class:"detail-content"},Oe={class:"detail-grid"},Le={class:"detail-item full-width"},Ee={class:"label-row"},be={class:"json-block"},he={class:"detail-item full-width"},Me={class:"label-row"},Ce={class:"json-block"},Se={class:"detail-item full-width"},ye={class:"label-row"},fe={class:"json-block"},ve=ue({__name:"SysHttpLog",setup(Ue){const I=N(de),O=N(!1),o=N(null),S=N(["basic","request"]),D=T(()=>{var t,e,p,c,u,d;return[{label:"日志ID",value:(t=o.value)==null?void 0:t.id,type:"code"},{label:"请求方式",value:(e=o.value)==null?void 0:e.reqMethod},{label:"请求地址",value:(p=o.value)==null?void 0:p.reqUrl,type:"code",fullWidth:!0},{label:"响应状态",value:(c=o.value)==null?void 0:c.repState},{label:"耗时",value:(u=o.value)!=null&&u.repTime?`${o.value.repTime} ms`:void 0},{label:"调用时间",value:(d=o.value)==null?void 0:d.createTime,fullWidth:!0}]}),r=A({reqMethod:"",reqUrl:"",createTime:null}),_=A({pageNum:1,pageSize:20}),L=T(()=>{var e;let t=I.value;if(r.reqMethod&&(t=t.filter(p=>p.reqMethod===r.reqMethod)),r.reqUrl&&(t=t.filter(p=>ae(r.reqUrl,p.reqUrl))),((e=r.createTime)==null?void 0:e.length)===2){const[p,c]=r.createTime;t=t.filter(u=>{const d=u.createTime.split(" ")[0];return d>=p&&d<=c})}return t}),q=T(()=>L.value.length),x=T(()=>le(L.value,_.pageNum,_.pageSize)),R=[{prop:"id",label:"日志ID",width:120,cellType:"code"},{prop:"reqMethod",label:"请求方式",width:100,cellType:"tag",tagMap:{GET:"success",POST:"",POST_FORM:"",POST_JSON:"",PUT:"warning",DELETE:"danger"},tagLabelMap:{GET:"GET",POST:"POST",POST_FORM:"POST_FORM",POST_JSON:"POST_JSON",PUT:"PUT",DELETE:"DELETE"}},{prop:"reqUrl",label:"请求地址",minWidth:300,align:"left",showOverflowTooltip:!0},{prop:"repState",label:"响应状态",width:100,cellType:"tag",tagMap:X,tagLabelMap:z},{prop:"repTime",label:"耗时(ms)",width:90},{type:"audit",prop:"createTime",label:"调用时间"},{type:"actions",label:"操作",slot:"actions"}],w=[{label:"详情",icon:se,handler:t=>P(t)}];function y(){_.pageNum=1}function V(){Q("接口日志",["日志ID","请求方式","请求地址","响应状态","耗时(ms)","调用时间"],L.value.map(t=>[t.id,t.reqMethod,t.reqUrl,t.repState,t.repTime,t.createTime]))}async function E(t){ee(t)}async function P(t){const e=await _e(t.id);e?(o.value=e,O.value=!0):ie.warning("未找到详情")}return(t,e)=>{const p=C("table-structure-drawer"),c=K,u=Y,d=Z,g=j,k=J,F=$,H=C("panel-layout"),B=C("detail-list"),f=pe,G=re,W=te;return v(),U(me,null,[l(H,{title:"接口日志"},{"title-extra":s(()=>[l(p,{sql:i(Ne)},null,8,["sql"])]),search:s(()=>[l(c,{modelValue:r.reqMethod,"onUpdate:modelValue":e[0]||(e[0]=a=>r.reqMethod=a),placeholder:"请求方式",options:i(ce),onSearch:y},null,8,["modelValue","options"]),l(u,{modelValue:r.reqUrl,"onUpdate:modelValue":e[1]||(e[1]=a=>r.reqUrl=a),placeholder:"搜索请求地址",onSearch:y},null,8,["modelValue"]),l(d,{modelValue:r.createTime,"onUpdate:modelValue":e[2]||(e[2]=a=>r.createTime=a),"start-placeholder":"开始日期","end-placeholder":"结束日期"},null,8,["modelValue"])]),actions:s(()=>[l(g,{type:"success",icon:i(ne),"margin-left":10,onClick:V},{default:s(()=>[...e[10]||(e[10]=[m("导出",-1)])]),_:1},8,["icon"])]),default:s(()=>[l(F,{"page-num":_.pageNum,"onUpdate:pageNum":e[3]||(e[3]=a=>_.pageNum=a),"page-size":_.pageSize,"onUpdate:pageSize":e[4]||(e[4]=a=>_.pageSize=a),data:x.value,columns:R,total:q.value,"row-key":"id","show-tool-bar":!1},{actions:s(({row:a})=>[l(k,{items:w,row:a},null,8,["row"])]),_:1},8,["page-num","page-size","data","total"])]),_:1}),l(W,{modelValue:O.value,"onUpdate:modelValue":e[9]||(e[9]=a=>O.value=a),title:"接口请求详情",direction:"rtl",size:"580px","destroy-on-close":"","hide-footer":!0},{default:s(()=>[o.value?(v(),U("div",Te,[l(G,{modelValue:S.value,"onUpdate:modelValue":e[8]||(e[8]=a=>S.value=a)},{default:s(()=>[l(f,{title:"基础信息",name:"basic"},{default:s(()=>[l(B,{items:D.value,column:2},null,8,["items"])]),_:1}),l(f,{title:"报文信息",name:"request"},{default:s(()=>[n("div",Oe,[n("div",Le,[n("div",Ee,[e[12]||(e[12]=n("span",{class:"detail-label"},"请求头",-1)),l(g,{link:"",type:"primary",icon:i(b),onClick:e[5]||(e[5]=a=>E(o.value.reqHeader||"-"))},{default:s(()=>[...e[11]||(e[11]=[m("复制",-1)])]),_:1},8,["icon"])]),n("pre",be,M(i(h)(o.value.reqHeader||"-")),1)]),n("div",he,[n("div",Me,[e[14]||(e[14]=n("span",{class:"detail-label"},"请求参数",-1)),l(g,{link:"",type:"primary",icon:i(b),onClick:e[6]||(e[6]=a=>E(o.value.reqParams))},{default:s(()=>[...e[13]||(e[13]=[m("复制",-1)])]),_:1},8,["icon"])]),n("pre",Ce,M(i(h)(o.value.reqParams)),1)]),n("div",Se,[n("div",ye,[e[16]||(e[16]=n("span",{class:"detail-label"},"响应数据",-1)),l(g,{link:"",type:"primary",icon:i(b),onClick:e[7]||(e[7]=a=>E(o.value.repData))},{default:s(()=>[...e[15]||(e[15]=[m("复制",-1)])]),_:1},8,["icon"])]),n("pre",fe,M(i(h)(o.value.repData)),1)])])]),_:1})]),_:1},8,["modelValue"])])):ge("",!0)]),_:1},8,["modelValue"])],64)}}}),He=oe(ve,[["__scopeId","data-v-583a680c"]]);export{He as default};

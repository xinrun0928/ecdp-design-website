import{t as j,aP as K,aQ as Y,u as Z,a as J,z as Q,aM as H,aN as ee,w as ae,aR as se,a2 as te,C as le,A as oe,$ as f,Z as ne,d as ce}from"./index-wKl0coRl.js";import{b9 as _e,bm as re,a_ as U,a as A}from"./element-plus-6J5z1N_S.js";import{g as ie,m as pe}from"./logMockApi-Dya0QwNo.js";import{f as v}from"./json-C7YhXd02.js";import{G as ue,L as m,M as I,a0 as n,W as o,u as i,_ as N,P as t,$ as p,O as D,Z as C,F as ge,r as M,k as h,c as O,aj as y}from"./vue-vendor-B_-BtTOt.js";import"./markdown-D0O8fouD.js";import"./editor-DMLWmuk0.js";import"./ol-map-Dw1FiBAf.js";import"./mockCrud-S4RZBBPa.js";const de=`-- Table structure for sys_access_log
-- ----------------------------
...
-- ----------------------------
`,me={key:0,class:"detail-content"},Ne={class:"detail-summary__main"},Oe={class:"detail-summary__name"},Le={class:"detail-summary__url"},Te={class:"detail-summary__meta"},Ee={class:"payload-section"},Ce={class:"label-row"},Me={class:"json-block"},ye={class:"payload-section"},be={class:"label-row"},Se={class:"json-block"},fe=ue({__name:"SysAccessLog",setup(Ue){const x=M(pe),L=M(!1),s=M(null),c=h({name:"",reqUrl:"",createTime:null}),_=h({pageNum:1,pageSize:20}),g=O(()=>{var e;let a=x.value;if(c.name&&(a=a.filter(r=>f(c.name,r.name))),c.reqUrl&&(a=a.filter(r=>f(c.reqUrl,r.reqUrl))),((e=c.createTime)==null?void 0:e.length)===2){const[r,d]=c.createTime;a=a.filter(T=>{const u=T.createTime.split(" ")[0];return u>=r&&u<=d})}return a}),w=O(()=>g.value.length),k=O(()=>ne(g.value,_.pageNum,_.pageSize)),q=O(()=>s.value?[{label:"日志 ID",value:s.value.id,type:"code"},{label:"访问时间",value:s.value.createTime},{label:"IP 地址",value:s.value.ip,type:"code"},{label:"客户端",value:`${s.value.browser} / ${s.value.os}`}]:[]),R=[{prop:"name",label:"日志名称",minWidth:140},{prop:"reqUrl",label:"请求地址",minWidth:240,align:"left",showOverflowTooltip:!0},{prop:"opMethod",label:"方法",width:80,cellType:"tag",tagMap:{GET:"success",POST:"",PUT:"warning",DELETE:"danger"},tagLabelMap:{GET:"GET",POST:"POST",PUT:"PUT",DELETE:"DELETE"}},{prop:"result",label:"结果",width:100,cellType:"tag",tagMap:Y,tagLabelMap:K},{prop:"repTime",label:"耗时(ms)",width:90},{prop:"ip",label:"IP地址",width:130},{prop:"browser",label:"浏览器",width:100},{prop:"os",label:"操作系统",width:100},{type:"audit",prop:"createTime",label:"访问时间"},{type:"actions",label:"操作",slot:"actions"}],P=[{label:"详情",icon:_e,handler:a=>F(a)}];function b(){_.pageNum=1}function V(){if(!g.value.length){A.warning("暂无数据可导出");return}te("访问日志",["日志ID","日志名称","请求地址","方法","结果","耗时(ms)","IP地址","浏览器","操作系统","访问时间"],g.value.map(a=>[a.id,a.name,a.reqUrl,a.opMethod,a.result,a.repTime,a.ip,a.browser,a.os,a.createTime]))}async function S(a){le(a)}async function F(a){const e=await ie(a.id);e?(s.value=e,L.value=!0):A.warning("未找到详情")}return(a,e)=>{const r=y("table-structure-drawer"),d=Q,T=H,u=J,G=Z,$=j,z=y("panel-layout"),B=ae,E=ee,X=y("detail-list"),W=oe;return m(),I(ge,null,[n(z,{title:"访问日志"},{"title-extra":o(()=>[n(r,{sql:i(de)},null,8,["sql"])]),search:o(()=>[n(d,{modelValue:c.name,"onUpdate:modelValue":e[0]||(e[0]=l=>c.name=l),placeholder:"搜索日志名称",onSearch:b},null,8,["modelValue"]),n(d,{modelValue:c.reqUrl,"onUpdate:modelValue":e[1]||(e[1]=l=>c.reqUrl=l),placeholder:"搜索请求地址",onSearch:b},null,8,["modelValue"]),n(T,{modelValue:c.createTime,"onUpdate:modelValue":e[2]||(e[2]=l=>c.createTime=l),"start-placeholder":"开始日期","end-placeholder":"结束日期"},null,8,["modelValue"])]),actions:o(()=>[n(u,{type:"success",icon:i(re),"margin-left":10,onClick:V},{default:o(()=>[...e[8]||(e[8]=[N("导出",-1)])]),_:1},8,["icon"])]),default:o(()=>[n($,{"page-num":_.pageNum,"onUpdate:pageNum":e[3]||(e[3]=l=>_.pageNum=l),"page-size":_.pageSize,"onUpdate:pageSize":e[4]||(e[4]=l=>_.pageSize=l),data:k.value,columns:R,total:w.value,"row-key":"id","show-tool-bar":!1},{actions:o(({row:l})=>[n(G,{items:P,row:l},null,8,["row"])]),_:1},8,["page-num","page-size","data","total"])]),_:1}),n(W,{modelValue:L.value,"onUpdate:modelValue":e[7]||(e[7]=l=>L.value=l),title:"访问日志详情",direction:"rtl",size:"580px","destroy-on-close":"","hide-footer":!0},{default:o(()=>[s.value?(m(),I("div",me,[n(E,{class:"detail-summary"},{default:o(()=>[t("div",Ne,[t("span",Oe,p(s.value.name),1),t("span",Le,p(s.value.reqUrl),1)]),t("div",Te,[n(B,{type:s.value.result===i(se).SUCCESS?"success":"danger",effect:"dark",round:""},{default:o(()=>[N(p(s.value.result),1)]),_:1},8,["type"]),t("span",null,p(s.value.opMethod),1),t("span",null,p(s.value.repTime)+" ms",1)])]),_:1}),n(E,{class:"detail-section"},{header:o(()=>[...e[9]||(e[9]=[t("span",{class:"detail-section__title"},"基础信息",-1)])]),default:o(()=>[n(X,{items:q.value},null,8,["items"])]),_:1}),n(E,{class:"detail-section"},{header:o(()=>[...e[10]||(e[10]=[t("span",{class:"detail-section__title"},"报文信息",-1)])]),default:o(()=>[t("section",Ee,[t("header",Ce,[e[12]||(e[12]=t("span",{class:"detail-label"},"请求参数",-1)),s.value.reqParams?(m(),D(u,{key:0,link:"",type:"primary",icon:i(U),onClick:e[5]||(e[5]=l=>S(s.value.reqParams))},{default:o(()=>[...e[11]||(e[11]=[N("复制",-1)])]),_:1},8,["icon"])):C("",!0)]),t("pre",Me,p(i(v)(s.value.reqParams||"-")),1)]),t("section",ye,[t("header",be,[e[14]||(e[14]=t("span",{class:"detail-label"},"响应数据",-1)),s.value.repData?(m(),D(u,{key:0,link:"",type:"primary",icon:i(U),onClick:e[6]||(e[6]=l=>S(s.value.repData))},{default:o(()=>[...e[13]||(e[13]=[N("复制",-1)])]),_:1},8,["icon"])):C("",!0)]),t("pre",Se,p(i(v)(s.value.repData||"-")),1)])]),_:1})])):C("",!0)]),_:1},8,["modelValue"])],64)}}}),Re=ce(fe,[["__scopeId","data-v-f0eadf29"]]);export{Re as default};

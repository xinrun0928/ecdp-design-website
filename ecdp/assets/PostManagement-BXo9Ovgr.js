...
-- ----------------------------
`,ke=Ne({__name:"PostManagement",setup(E){const c=N(!1),L=N(!1),d=N(ce(Te)),m=N(!1),p=N(!1),b=N(),T=y({postName:""}),t=y({postName:"",parentId:0,unitName:"",status:o.NORMAL,remark:""}),v={postName:[{required:!0,message:"请输入岗位名称",trigger:"blur"}],unitName:[{required:!0,message:"请选择所属单位",trigger:"change"}],status:[{required:!0,message:"请选择状态",trigger:"change"}]},C=[{prop:"postName",label:"岗位名称",minWidth:200,fixed:"left",align:"left",headerAlign:"left"},{prop:"unitName",label:"所属单位",minWidth:140,align:"center"},{prop:"status",label:"启用状态",width:100,align:"center",cellType:"tag",tagMap:{1101:"success",1102:"info"},tagLabelMap:{1101:"启用",1102:"停用"}},{prop:"remark",label:"备注信息",minWidth:200,align:"center",showOverflowTooltip:!0},{prop:"creater",label:"创建人",width:100,align:"center",cellType:"secondary"},{prop:"createTime",label:"创建时间",width:175,align:"center",cellType:"secondary"},{label:"操作",width:60,fixed:"right",align:"center",slot:"actions"}],f=h(()=>{if(!T.postName)return d.value;const a=n=>n.filter(e=>{const u=ne(T.postName,e.postName),_=e.children&&a(e.children).length>0;return u||_}).map(e=>({...e,children:e.children?a(e.children):[]}));return a(d.value)}),R=h(()=>{const a=n=>d.value.filter(e=>e.parentId===n).map(e=>({id:e.id,postName:e.postName,children:a(e.id)}));return[{id:0,postName:"顶级岗位",children:a(0)}]}),D=[{label:"修改",icon:re,handler:a=>x(a)},{label:"子项",icon:le,handler:a=>I(a)},{label:"删除",icon:oe,divided:!0,handler:a=>F(a)}];function k(){}function I(a){p.value=!1,t.id=void 0,t.parentId=a?a.id:0,t.postName="",t.unitName="",t.status=o.NORMAL,t.remark="",m.value=!0}function x(a){p.value=!0,t.id=a.id,t.parentId=a.parentId,t.postName=a.postName,t.unitName=a.unitName,t.status=a.status,t.remark=a.remark,m.value=!0}async function V(){if(b.value){try{await b.value.validate()}catch{return}L.value=!0,setTimeout(()=>{if(p.value&&t.id){const a=n=>{for(const e of n){if(e.id===t.id)return e.postName=t.postName,e.parentId=t.parentId,e.unitName=t.unitName,e.status=t.status,e.remark=t.remark,!0;if(e.children&&a(e.children))return!0}return!1};a(d.value),g.success("修改成功，数据已更新")}else{const a={id:Date.now(),postName:t.postName,parentId:t.parentId,unitName:t.unitName,status:t.status,remark:t.remark,children:[]};if(t.parentId===0)d.value.push(a);else{const n=e=>{for(const u of e){if(u.id===t.parentId)return u.children||(u.children=[]),u.children.push(a),!0;if(u.children&&n(u.children))return!0}return!1};n(d.value)}g.success("新增成功，岗位已创建")}m.value=!1,L.value=!1},400)}}function w(){var a;(a=b.value)==null||a.resetFields()}async function F(a){if(!await ee(a.postName))return;c.value=!0;const n=e=>{const u=e.findIndex(_=>_.id===a.id);if(u!==-1)return e.splice(u,1),!0;for(const _ of e)if(_.children&&n(_.children))return!0;return!1};n(d.value),g.success("删除成功"),c.value=!1}function B(){const a=C.filter(e=>e.label!=="操作").map(e=>e.label),n=be(f.value).map(e=>[e.postName,e.unitName,e.status,e.remark,e.creater,e.createTime]);te("岗位管理",a,n)}return(a,n)=>{const e=U("table-structure-drawer"),u=Q,_=H,P=j,G=z,X=U("panel-layout"),q=pe,M=de,A=_e,W=J,$=Z,K=ue,Y=ae;return Oe(),Le(Me,null,[l(X,{title:"岗位管理"},{"title-extra":i(()=>[l(e,{sql:[O(Ee),O(Ce)]},null,8,["sql"])]),search:i(()=>[l(u,{modelValue:T.postName,"onUpdate:modelValue":n[0]||(n[0]=r=>T.postName=r),placeholder:"请输入岗位名称",clearable:"",onSearch:k},null,8,["modelValue"])]),actions:i(()=>[l(_,{icon:O(se),"margin-left":10,onClick:n[1]||(n[1]=r=>I(null))},{default:i(()=>[...n[8]||(n[8]=[S("新增岗位",-1)])]),_:1},8,["icon"]),l(_,{icon:O(ie),type:"success","margin-left":10,onClick:B},{default:i(()=>[...n[9]||(n[9]=[S("导出",-1)])]),_:1},8,["icon"])]),default:i(()=>[l(G,{data:f.value,columns:C,"row-key":"id","tree-props":{children:"children",hasChildren:"hasChildren"},"default-expand-all":!0,indent:24,"show-index":!1,"show-pagination":!1,"show-tool-bar":!1,loading:c.value},{actions:i(({row:r})=>[l(P,{items:D,row:r},null,8,["row"])]),_:1},8,["data","loading"])]),_:1}),l(Y,{modelValue:m.value,"onUpdate:modelValue":n[7]||(n[7]=r=>m.value=r),title:p.value?"修改岗位":"新增岗位",size:480,"destroy-on-close":!0,"confirm-text":p.value?"保存修改":"确认创建","on-confirm":V,onClosed:w},{default:i(()=>[l(K,{ref_key:"formRef",ref:b,model:t,rules:v,"label-width":"100px","label-position":"right"},{default:i(()=>[l(M,{label:"上一层级",prop:"parentId"},{default:i(()=>[l(q,{modelValue:t.parentId,"onUpdate:modelValue":n[2]||(n[2]=r=>t.parentId=r),data:R.value,props:{label:"postName",children:"children"},"check-strictly":"","render-after-expand":!1,placeholder:"请选择上级岗位（不选则为顶级）",clearable:"",style:{width:"100%"}},null,8,["modelValue","data"])]),_:1}),l(M,{label:"岗位名称",prop:"postName"},{default:i(()=>[l(A,{modelValue:t.postName,"onUpdate:modelValue":n[3]||(n[3]=r=>t.postName=r),placeholder:"请输入岗位名称",maxlength:"50","show-word-limit":""},null,8,["modelValue"])]),_:1}),l(M,{label:"所属单位",prop:"unitName"},{default:i(()=>[l(W,{modelValue:t.unitName,"onUpdate:modelValue":n[4]||(n[4]=r=>t.unitName=r),options:O(ge).map(r=>({label:r,value:r})),placeholder:"请选择所属单位"},null,8,["modelValue","options"])]),_:1}),l(M,{label:"状态",prop:"status"},{default:i(()=>[l($,{modelValue:t.status,"onUpdate:modelValue":n[5]||(n[5]=r=>t.status=r),options:O(me)},null,8,["modelValue","options"])]),_:1}),l(M,{label:"备注信息",prop:"remark"},{default:i(()=>[l(A,{modelValue:t.remark,"onUpdate:modelValue":n[6]||(n[6]=r=>t.remark=r),type:"textarea",rows:3,placeholder:"请输入备注信息",maxlength:"200","show-word-limit":""},null,8,["modelValue"])]),_:1})]),_:1},8,["model"])]),_:1},8,["modelValue","title","confirm-text"])],64)}}});export{ke as default};
